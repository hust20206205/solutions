...
<!--Theo Eric Evans, một mô hình domain quan trọng là ý tưởng mà biểu đồ đó muốn truyền đạt.-->
...
Chúng ta cần tổ chức thông tin, hệ thống hóa nó, chia nó thành những phần nhỏ hơn, nhóm nó thành các mô-đun theo logic, xử lý từng cái một.
