...
Tuy nhiên, để xây dựng được kiến ​​trúc vi dịch vụ



Một điểm quan trọng cần lưu ý là nhóm kiến ​​trúc vi dịch vụ phải tạo ra phạm vi kinh doanh phù hợp cho từng vi dịch vụ để duy trì tính độc lập.

<!--Một điều quan trọng cần lưu ý là để tận dụng tối đa kiến ​​trúc vi dịch vụ, điều quan trọng đối với nhóm vi dịch vụ là phải tạo ra mã nghiệp vụ phù hợp cho từng máy chủ vi mô.-->
<!--Nếu không thực hiện đúng sẽ dẫn đến tình trạng các nhóm phụ thuộc lẫn nhau và điều đó sẽ dẫn đến mất đi lợi thế của kiến ​​trúc vi dịch vụ.-->
