...
%!<! - - [[Ngôn ngữ phổ biến]] Một ngôn ngữ được cấu trúc xung quanh mô hình miền và được tất cả các thành viên trong nhóm sử dụng để kết nối mọi hoạt động của nhóm với phần mềm. - - >
