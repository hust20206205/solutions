...
Trong microservice Các dịch vụ cần tương tác với các dịch vụ khác. Từ đó, Sẽ có những mối quan hệ phụ thuộc. Những mối quan hệ này cần được quản lý.



=> Vì vậy, Các nhóm phải nỗ lực phải ghi lại mối quan hệ giữa các điểm tiếp xúc được liên kết bằng cách sử dụng Bản đồ bối cảnh
