...
Thiết kế hướng miền DDD nhấn mạnh dùng lĩnh vực nghiệp vụ để thảo luận, giải pháp đáp ứng nhu cầu mà không phải những chủ đề đặc thù kỹ thuật. Để tạo ta một phần mềm tốt, bạn cần hiểu về phần mềm đó.
Đây là nơi chúng ta thường xuất phát: Lĩnh vực (nghiệp vụ) 
