...
Điều này được thực hiện chủ yếu bằng cách phỏng vấn các chuyên gia. Chúng ta cũng có thể quan sát doanh nghiệp để hiểu về mô hình kinh doanh của họ.
...
Chúng ta phải bắt đầu bằng cách xem xét khả năng kinh doanh trong miền phụ đó. Có giải pháp nào được biết đến cho miền phụ đó không?
...
Chúng ta viết ra câu trả lời của mình rồi tôi sẽ trao đổi suy nghĩ của mình để hỗ trợ khách hàng. John đã đề cập đến một số điều khiến tôi hơi bối rối.

18
00: 02: 45, 690--> 00: 02: 58, 740
Chúng ta đã đề cập rằng bộ phận hỗ trợ khách hàng giúp Acme khác biệt với các đối thủ cạnh tranh, nhưng đồng thời, anh ấy cũng đề cập rằng có sẵn các công cụ hỗ trợ khách hàng để họ có thể đưa ra tòa hoặc miền hỗ trợ.
...
Đội ngũ bán hàng luôn tìm kiếm những cách sáng tạo để bán sản phẩm Acme và nhân lực. John đã đề cập rất thuận tiện với chúng tôi rằng nhóm ngũ quản lý biết họ đang làm gì.
...
Chúng ta nghĩ sao? Vì vậy, có một điều rõ ràng. Hoạt động tiếp thị sẽ tạo sự khác biệt cho Acme với các đối thủ cạnh tranh, nhưng đồng thời hoạt động tiếp thị dường như không hề phức tạp.
...
Và tại thời điểm này, chúng ta cần trả lời câu hỏi sẽ giúp Jack đưa ra quyết định. Chúng ta sẽ bảo Jack làm gì?
...
Chúng ta sẽ nói gì với anh ấy? Rõ ràng, lần này chúng ta ở vị trí có thể hướng dẫn Jack với mức độ tin cậy cao và chúng ta sẽ nói với anh ấy rằng anh ấy nên chọn một tài khoản có lãi suất thấp.
...
Chúng ta có thể tưởng tượng cuốn từ điển kinh doanh này đã đi đến đâu trong một khoảng thời gian. ngôn ngữ chung không được tạo và quản lý tập trung.
...
Chúng ta có thể sử dụng bất kỳ công cụ nào miễn là nó giúp tất cả thành viên trong nhóm có thể tiếp cận được ngôn ngữ chung này. Các công cụ cộng tác và chia sẻ kiến ​​thức như hội nghị và quip thường được sử dụng.
...
Và sau đó ngôn ngữ này sẽ phát triển theo thời gian. Các chuyên gia ngành nên sử dụng nó. Các nhóm giao hàng phải sử dụng nó cho công việc chung hàng ngày của họ.
...
Đây không phải là công việc chỉ làm một lần mà nó được tạo ra bởi sự cộng tác giữa chuyên gia ngành và chuyên gia công nghệ.
...
Vì vậy anh ấy đóng một vai trò cực kỳ quan trọng trong bài tập này. Chúng ta sẽ xem qua bản ghi mà chúng ta đã ghi lại làm người dẫn đầu và xác định càng nhiều thuật ngữ ngôn ngữ chung càng tốt tại thời điểm này.
...
Chúng ta đã biết ý nghĩa của ngữ cảnh giới hạn ở đây có nghĩa là bị giới hạn trong hoặc trong một loại ranh giới nào đó, và ý nghĩa của từ độc lập là không bị kiểm soát từ bên ngoài hoặc không phụ thuộc vào bất kỳ thực thể nào khác.
...
Chúng ta cần tận dụng các tài sản hiện có và chúng ta cần hợp tác với các chuyên gia trong lĩnh vực, hãy bắt đầu bằng cách xem xét cơ cấu tổ chức.
...
Xác định các chuyên gia ngành trong các lĩnh vực cốt lõi và hợp tác với họ để hiểu trách nhiệm của họ cũng như các hoạt động chính mà họ tham gia.
...
Đi sâu hơn vào từng hoạt động này với sự cộng tác của các chuyên gia ngành sẽ giúp các chuyên gia hiểu được ranh giới bối cảnh trong lĩnh vực ngân hàng tiêu dùng.

26
00: 04: 44, 250--> 00: 04: 59, 130
Chúng ta, với tư cách là chuyên gia CNTT, cần cộng tác với các chuyên gia ngành để xác định các hoạt động chính phù hợp trong tổ chức của mình và sau đó tìm hiểu sâu hơn về từng hoạt động này.
...
Và những cuộc gọi này cũng được nhóm ngũ hỗ trợ tiếp nhận. Bây giờ chúng ta đã biết trách nhiệm của nhóm hỗ trợ, hãy đi vào chi tiết về các hoạt động chính được thực hiện bằng cách hỗ trợ khách hàng và nhà cung cấp được gọi là số điện thoại miễn phí chung cho trung tâm cuộc gọi của Hackman.
...
Chăm sóc khách hàng. Sau đó, nhóm ngũ chăm sóc khách hàng sẽ tiến hành điều tra và làm việc trực tiếp với khách hàng để giải quyết vấn đề và đóng phiếu yêu cầu.
...
Nếu không, nhân viên dựa trên vấn đề sẽ chỉ định trường hợp nhà cung cấp cho một nhóm thích hợp. Ví dụ, trong nội bộ Achmat, nếu là vấn đề hợp đồng thì nhóm quản lý đối tác sẽ được phân công xử lý nếu liên quan đến kế toán và nhóm kế toán sẽ được giao phiếu xử lý.
...
Chúng ta sẽ học tất cả các mẫu hình mối quan hệ trong phần này. Big bowl of Maat là một đối cực trong quá trình phát triển phần mềm và với tư cách là nhà thiết kế các vi dịch vụ, chúng ta phải tránh tạo ra một bối cảnh lớn.
...
Để đáp lại lệnh gọi hàm get inactive, kho lưu trữ tài khoản có thể thực thi một câu lệnh chọn với một mệnh đề mơ hồ hoặc có thể gọi một API trên CSDL không an toàn để truy xuất các tài liệu phù hợp với tiêu chí đã chỉ định.
...
Là một phần của bài giảng đó, tôi đã thảo luận về một hàm trên đối tượng tài khoản yêu cầu cập nhật trên hai bảng trong CSDL .
...
Tất cả các thay đổi đối với CSDL đều thành công hoặc không có thay đổi nào được thực hiện đối với bất kỳ thực thể nào là một phần của tổng hợp.

29
00: 05: 20, 960--> 00: 05: 37, 460
Và điều này có thể xảy ra nếu có bất kỳ lỗi nào trong hoạt động CSDL đối với bất kỳ thực thể nào. Nhìn chung, lợi ích chính của việc sử dụng kho lưu trữ là nó giữ cho mô hình miền độc lập với lớp lưu trữ.
...
Ý tưởng rất đơn giản để thực hiện kiểm tra mã máy khách. Cơ sở dữ liệu có thể được thay thế bằng cách triển khai mô hình CSDL .

35
00: 06: 42, 370--> 00: 06: 59, 840
Ví dụ: đây có thể là các pogo đơn giản hoặc các đối tượng Java đơn giản đang quay trở lại. Phản hồi CSDL tĩnh được sử dụng rộng rãi làm cơ chế xây dựng mô hình vì nó giúp tôi di chuyển nhanh hơn mà không phụ thuộc vào sự sẵn có của CSDL thực.
...
Và lý do cho mối lo ngại này là đối với các đối tượng tổng hợp lớn, có thể cần phải thực thi nhiều thao tác CSDL hoặc có thể cần phải nối trên nhiều bảng, điều này có thể dẫn đến hiệu suất truy vấn dưới mức tối ưu để giải quyết mối lo ngại này.
...
Thêm về chủ đề này trong một bài giảng sau. Việc hiện thực hóa kho lưu trữ yêu cầu nhà phát triển phải ánh xạ giữa đối tượng miền và CSDL và ngược lại.
...
Chúng ta có thể cân nhắc sử dụng các khung ánh xạ có sẵn ở đó. Các khung ánh xạ này đơn giản hóa nhiệm vụ ánh xạ giữa các đối tượng miền và CSDL .
...
Tôi sẽ hướng dẫn chúng ta một số tệp mã, nhưng không phải tất cả. Chúng ta có thể tự mình xem qua các tệp mã khác và chỉ cần lưu ý rằng đó là tùy chọn.
...
Họ không thực hiện việc thực hiện chức năng thực tế của hệ thống lưu trữ. Tất cả các tương tác của hệ thống lưu trữ được tách biệt trong một tập hợp các đối tượng riêng biệt triển khai giao diện kho lưu trữ, ví dụ: tuyến tổng hợp khách hàng sẽ được liên kết với giao diện khách hàng và giao diện khách hàng đó sẽ được đối tượng báo cáo khách hàng triển khai, chẳng hạn như một CSDL .
...
Ý tưởng là trong tương lai chúng ta có thể quyết định tạo một tập hợp đối tượng REPL khác, sẽ triển khai các chức năng giao diện nhưng sẽ thực hiện các tương tác với CSDL thực tế.

13
00: 03: 00, 080--> 00: 03: 13, 060
Vì vậy, trên thực tế, các lớp trong mô hình Commodore Akhmad báo cáo gói CSDL của chúng tôi sẽ triển khai các giao diện tương ứng và Commodore Achmad hoặc mô hình hoặc bộ ba.
...
Đã đến lúc cho một bài kiểm tra. Giả sử mô hình miền của ngân hàng có ba thực thể này. Chúng ta được yêu cầu tạo danh mục khách hàng dịch vụ, danh mục này sẽ cung cấp tất cả dữ liệu từ ba thực thể này.
...
Và cơ chế bền vững này, có thể là CSDL bên ngoài hoặc thậm chí là hệ thống tệp, đối tượng miền thường phụ thuộc vào các dịch vụ hoặc ứng dụng bên ngoài như API Salesforce hoặc thậm chí Google Map.
...
Chúng ta đã chuẩn bị sơ đồ trình tự cho quá trình tạo đề xuất và cách tốt nhất là nhận phản hồi về tất cả nội dung mô hình kinh doanh này từ các bên liên quan trong kinh doanh.
...
Chúng ta sẽ thêm phụ phí và các điều khoản về giá mỗi người vào từ vựng kinh doanh vốn là ngôn ngữ chung của chúng ta và một số phụ phí là một thuật ngữ mới.

8
00: 01: 28, 060--> 00: 01: 35, 470
Chúng ta muốn hiểu nó tốt hơn. Vì vậy, chúng ta đã yêu cầu John cung cấp cho chúng ta thông tin chi tiết về cách tính các khoản phụ phí.
...
Các ứng dụng SCDP cuối cùng là một cơ chế Đồng bộ hóa phổ biến mà qua đó các vi dịch vụ tương tác trong phần này.

3
00: 00: 22, 800--> 00: 00: 36, 630
Chúng ta sẽ biết rằng các vi dịch vụ cũng tạo ra nhiều loại sự kiện khác nhau. Những sự kiện này được sử dụng bởi các vi dịch vụ khác cũng như các thành phần trong bối cảnh liên kết nơi sự kiện được tạo ra.

4
00: 00: 36, 990--> 00: 00: 46, 080
Bây giờ hãy nói về mối quan hệ giữa kiến ​​trúc điều khiển chẵn và các vi dịch vụ . Kiến trúc thậm chí được định hướng cũng là một mô hình kiến ​​trúc.

5
00: 00: 46, 380--> 00: 00: 56, 890
Thúc đẩy việc sản xuất, phát hiện, tiêu thụ và phản ứng với các sự kiện và vi dịch vụ là những nhà sản xuất và tiêu dùng tự nhiên.

6
00: 00: 56, 910--> 00: 01: 04, 170
Do đó, kiến ​​trúc điều khiển đồng đều thường được sử dụng để xây dựng các ứng dụng có vi dịch vụ .
...
Chúng ta sẽ có thể mô tả sự khác biệt giữa một máy thu và nhiều máy thu. Và ở cuối bài học này, tôi cũng sẽ đưa ra một số ví dụ công nghệ để hiện thực hóa các mẫu mà tôi sẽ thảo luận trong bài giảng này.
...
Chúng ta sẽ thấy một số công nghệ này hoạt động trong các bài giảng sau của khóa học này. Đã đến lúc xem xét nhanh.
...
Microsoft cho biết các tương tác trong bài giảng này, tôi sẽ đề cập đến các mô hình giao tiếp trong Microsoft Office giữa Microsoft ISS và giữa Dịch vụ của Microsoft và các dịch vụ bên ngoài, các vi dịch vụ và Giao tiếp của Crossover đề cập đến các lệnh gọi chức năng được thực hiện giữa các thành phần trong cùng một bối cảnh liên kết.
...
Việc các vi dịch vụ giao tiếp với các dịch vụ bên ngoài là điều bình thường. Giao thức mạng và định dạng của tin nhắn được sử dụng bởi các dịch vụ bên ngoài này nằm ngoài tầm kiểm soát của Nhóm Phát triển Dịch vụ Vi mô.

12
00: 02: 58, 770--> 00: 03: 09, 270
Do đó, Nhóm phát triển vi dịch vụ cần tuân thủ các yêu cầu về giao diện và giao thức mạng của các dịch vụ bên ngoài này.

13
00: 03: 09, 570--> 00: 03: 27, 240
Ví dụ: có thể có một cổng thanh toán hiển thị giao diện của nó bằng HTP, một dịch vụ ghi nhật ký hiển thị giao diện của nó bằng cách nhắn tin và sau đó các CSDL thường được sử dụng có giao thức mạng độc quyền dựa trên TCP IP của riêng chúng.

14
00: 03: 27, 960--> 00: 03: 39, 180
Từ góc độ vi dịch vụ, chi tiết về giao thức mạng và định dạng nhắn tin này sẽ được gói gọn trong các dịch vụ cơ sở hạ tầng.

15
00: 03: 39, 450--> 00: 03: 54, 270
Như đã thảo luận trước đó, các dịch vụ cơ sở hạ tầng này sẽ chịu trách nhiệm giữ phần còn lại của mã vi dịch vụ độc lập với Giao thức dịch vụ bên ngoài cũng như các định dạng tin nhắn.

16
00: 03: 55, 460--> 00: 04: 08, 820
Đối với Giao tiếp giữa các dịch vụ trong Dịch vụ vi mô, nhà phát triển vi dịch vụ cần quyết định cấu trúc của thông báo yêu cầu và phản hồi, đồng thời họ cũng cần quyết định về định dạng.

17
00: 04: 08, 960--> 00: 04: 21, 650
Thông thường, một vi dịch vụ hiển thị giao diện sẽ sử dụng các đối tượng mô hình để xác định cấu trúc của thông báo yêu cầu và phản hồi từ phối cảnh chuyển tiếp.
...
Hai vi dịch vụ này được quản lý bởi hai nhóm độc lập và mỗi nhóm này phát triển mô hình riêng cho A và B.
...
Việc quản lý phụ thuộc cho các vi dịch vụ này được thực hiện theo các ranh giới, bối cảnh, mô hình tích hợp được xác định rõ ràng.
...
Tiếp theo là mẫu tuân thủ, như tên gợi ý trong mẫu này. Thứ nhất, Microsoft tuân thủ mô hình được xác định trong một vi dịch vụ khác.
...
Chúng ta có thể nghĩ về nó như một thành phần vật chất. Nó được gọi bằng nhiều tên, thậm chí Busse, thậm chí Broca, thậm chí cả sự kiện Serota, trung tâm sự kiện hòa giải.
...
Tôi khuyên chúng ta nên thực hiện nghiên cứu của riêng mình trên Google. Chúng ta sẽ tìm thấy rất nhiều thông tin. Điều quan trọng cần ghi nhớ là về mặt khái niệm chúng giống nhau.
...
Chúng ta sẽ sử dụng cả dữ liệu trạng thái và siêu dữ liệu trong mình, thậm chí cả tin nhắn. Không có quy tắc cứng nhắc và nhanh chóng, nhưng có những cân nhắc nhất định.
...
Chúng ta có thể nhấp vào tạo phiên bản mới. Ở đây chúng ta cần phải cung cấp một tên. Hãy gọi cho nhà môi giới Acme Travel.
...
Các khoản vay cá nhân được triển khai dưới dạng vi dịch vụ sẽ có các dịch vụ ứng dụng, dịch vụ miền và tổng hợp, đồng thời mỗi thành phần này có thể đưa ra các sự kiện để chỉ ra một số loại thay đổi trạng thái.
...
Tôi sẽ coi dịch vụ bên ngoài là API dịch vụ cũ hoặc bất kỳ dịch vụ nào khác không được triển khai dưới dạng vi dịch vụ trong những trường hợp như vậy.
...
Chúng ta phải sử dụng ngôn ngữ chung để không cần phải dịch giữa doanh nghiệp và ví dụ của nhóm CNTT.
...
Trong trường hợp miền, ngay cả trình xử lý cũng là một phần của cơ sở mã vi dịch vụ giống như nhà sản xuất chẵn.
...
Chúng ta có thể đặt tên cho trình xử lý giống với sự kiện mà trình xử lý đó đang xử lý. Ví dụ: Order Shib sẽ là tên của đối tượng sẽ xử lý thứ tự các sự kiện.
...
Hãy gọi đây là ứng dụng chẵn đã nhận được. Bây giờ, có thể có một trình xử lý trong cùng một vi dịch vụ này quan tâm đến việc phản hồi các sự kiện nhận được của ứng dụng.
...
Hãy để tôi giải thích điều này bằng một ví dụ. Trong vi dịch vụ cho vay cá nhân, tổng hợp đơn xin vay có trách nhiệm quản lý trạng thái của đơn xin vay.

50
00: 09: 11, 050--> 00: 09: 20, 860
Vì vậy khi khách hàng đăng ký vay, tổng hợp hồ sơ vay sẽ lưu trạng thái hồ sơ vay mới vào CSDL .
...
Tổng hợp không thể lưu ứng dụng vào CSDL, nhưng nó đã nâng cấp ứng dụng nhận được. Ngay cả trong trường hợp này, người xử lý sẽ nhận được thông báo nhưng sẽ không tìm thấy đơn xin vay trong CSDL .
...
Nó sẽ lưu ngay cả vào bộ lưu trữ, bộ lưu trữ, có thể chỉ trong bộ nhớ lưu trữ. Sau đó, tổng hợp đơn xin vay có thể cố gắng lưu ứng dụng vào CSDL .

58
00: 10: 41, 470--> 00: 10: 52, 820
Nếu có lỗi thì sự kiện sẽ không bị xóa. Nếu việc bán CSDL thành công thì sự kiện sẽ bị xóa và người xử lý sẽ được thông báo.
...
Xin lưu ý rằng tất cả các lệnh gọi hàm này đều đồng bộ. Trong lớp xe buýt chẵn. Chúng ta sẽ tìm thấy hàm đua và chúng ta sẽ tìm thấy ba bước mà tôi đã thảo luận trong sơ đồ trình tự.
...
Trong bài giảng về tích hợp, thậm chí, sự nghiệp của Alpha, so sánh các sự kiện tích hợp và miền, sau đó chúng ta sẽ thảo luận về tích hợp, thậm chí xử lý từ góc độ vi dịch vụ của người tiêu dùng.
...
Mặt khác, các sự kiện tích hợp được sử dụng bởi các vi dịch vụ khác bên ngoài bối cảnh bom con nguồn.
...
Chúng ta đang tạo một ứng dụng nguyên khối. Trong trường hợp các sự kiện miền, việc tiêu thụ sự kiện có thể đồng bộ, như với các lệnh gọi hàm trực tiếp.
...
Công nghệ nhắn tin được sử dụng phổ biến. Đây là một số công cụ nhắn tin rất phổ biến để xây dựng các vi dịch vụ .
...
Sự khác biệt nằm ở cách những sự kiện này được xuất bản và tiêu thụ. Nhưng nếu người thiết kế vi dịch vụ đã quyết định sử dụng cùng một cơ chế không đồng bộ cho cả hai loại sự kiện thì cơ chế xuất bản và kích hoạt sẽ giống nhau đối với các sự kiện miền và tích hợp.
...
Hãy xem lại ví dụ về khoản vay cá nhân, quản lý tài khoản, vi dịch vụ của chúng tôi. Giả sử có hai yêu cầu mới.

27
00: 05: 16, 960--> 00: 05: 33, 700
Yêu cầu đầu tiên không phải là bối cảnh giới hạn tuân thủ được triển khai vì một vi dịch vụ cần được thông báo khi nhận được đơn đăng ký mới và khách hàng cần được thông báo qua email khi tài khoản vay được thiết lập.
...
Chúng tôi có thể xuất bản miền ngay cả khi ứng dụng được nhận dưới dạng tích hợp. Ngay cả vi dịch vụ để tuân thủ cũng sẽ có thể nhận được sự đồng đều và thực hiện quá trình xử lý phù hợp trong bối cảnh giới hạn của nó.
...
Chúng ta có thấy điều gì thú vị ở đây không? Có một sự kiện khi việc đặt chỗ được xác nhận, vì vậy có vẻ như chúng tôi vừa phát hiện ra một sự kiện đặt chỗ mới được xác nhận yêu cầu không có ai có vẻ khá đơn giản.
...
Giả sử rằng đường trục nhắn tin được xây dựng trên Rabbit MQ và người đăng ký là các dịch vụ bên ngoài và các vi dịch vụ khác.
...
Vì vậy, thậm chí sẽ chỉ được nâng lên nếu đối tượng lưu trữ thành công trong quá trình triển khai repro. Chúng ta sẽ tìm hiểu thêm về nó trong một bài giảng sau.
...
Đây là giao diện dịch vụ nhắn tin của chúng tôi. Chúng ta sẽ tìm thấy các hàm đơn giản ở đây và chúng ta sẽ quan sát thấy rằng tất cả các hàm này đang đưa ra ngoại lệ nhắn tin được xác định ở đây.
...
Chúng tôi sẽ sử dụng lớp thử nghiệm dịch vụ phụ trong lớp này. Chúng ta sẽ thấy rằng tất cả đã được thiết lập để thực thi để kiểm tra chức năng công cộng, chỉ phát hiện ra các phần nổi bật của dịch vụ chứ không xuất bản và nhận xét bài kiểm tra người đăng ký.
...
Chạy cho bài kiểm tra này. Chúng ta sẽ thấy rằng trong thử nghiệm này, chúng tôi đã đăng ký chủ đề xác nhận đặt phòng Achmad hoặc bắt đầu bán hàng.
...
Đây là một chức năng địa phương. Chúng ta hãy xem nhanh chức năng này và chức năng này. Chúng ta sẽ thấy rằng tôi đang tạo phiên bản lớp dịch vụ bật lên, gửi các thuộc tính cho Amcu P, sau đó khởi động dịch vụ nhắn tin.
...
Phần quan trọng ở đây là tạo ra sự hiểu biết chung. Vì vậy, mục đích không phải là thiết kế hoặc mô hình hóa hệ thống mà chỉ tạo ra sự hiểu biết chung giữa các bên liên quan trong miền và các bên liên quan là các chuyên gia ngành cũng như chuyên gia công nghệ.
...
Chúng ta sẽ có rất nhiều giấy treo trên tường và sẽ có rất nhiều giấy dính trên đó. Các miếng dán được đặt trên một phần giấy, có mã màu.

28
00: 05: 49, 460--> 00: 06: 03, 490
Chúng ta tìm hiểu về ý nghĩa của những màu sắc này. Trong bài giảng tiếp theo của hội thảo trực tuyến, những người tham gia đã tham gia qua cuộc gọi điện video và họ sử dụng nền tảng cộng tác để thực hiện các hoạt động thậm chí còn gây bão.
...
Chúng ta có thể quyết định một tiêu chuẩn và chỉ cần làm theo nó trong suốt buổi hội thảo. Tác nhân miền gây ra thay đổi giai đoạn trong miền và thay đổi giai đoạn được bắt đầu bằng lệnh và bước đi của tác nhân.
...
Nói cách khác, chúng ta phải thiết lập hội nghị truyền hình. Chúng ta phải có công cụ để thiết lập cộng tác.
...
Chúng ta không muốn điều đó xảy ra. Vì vậy, hãy đảm bảo rằng nếu chúng ta tiến hành hội thảo từ xa, chúng ta phải chuẩn bị sẵn sàng mọi thứ vào ngày đầu tiên trước khi hội thảo bắt đầu.
...
Chúng ta có thể theo dõi các mục này sau buổi hội thảo. Một điều cuối cùng mà người hướng dẫn nên làm trước khi bắt đầu hội thảo là đặt ra những kỳ vọng và điều này được thực hiện tốt nhất theo kinh nghiệm của tôi, bằng cách chia sẻ kinh nghiệm thực tế từ các hội thảo trước đây và nếu có thể, chia sẻ hình ảnh từ những hội thảo đó, những kỳ vọng này nên được thực tế và cung cấp cho những người tham gia và hỏi họ suy nghĩ của họ về hội thảo đang gây bão, cũng như những gì họ mong đợi các ý tưởng sẽ khiến mọi người hào hứng để họ trở thành những người tham gia tích cực trong hội thảo và tất cả họ đều mong muốn được học và giảng dạy .
...
Tôi đã chọn một trường hợp sử dụng ví dụ. Đây sẽ là quy trình phê duyệt khoản vay của ngân hàng. Giả sử Người hướng dẫn đã mời nhóm CNTT cũng như các chuyên gia ngành có thể trả lời các câu hỏi liên quan đến các sản phẩm cho vay do ngân hàng cung cấp.
...
Cơ sở dữ liệu là một phần thiết yếu của tất cả các ứng dụng, các vi dịch vụ được phát triển độc lập bởi các nhóm khác nhau.

2
00: 00: 07, 980--> 00: 00: 21, 870
Mỗi nhóm có thể quyết định về công nghệ CSDL cũng như cấu trúc CSDL của mình. Mỗi nhóm có thể độc lập thực hiện các thay đổi đối với CSDL của riêng mình mà không ảnh hưởng đến các vi dịch vụ khác.

3
00: 00: 22, 260--> 00: 00: 40, 650
Việc chuyển đổi một ứng dụng nguyên khối sang các vi dịch vụ đòi hỏi người thiết kế không chỉ nghĩ đến việc tái cấu trúc logic nghiệp vụ và các thành phần của ứng dụng nguyên khối mà còn cần phải suy nghĩ về việc tái cấu trúc CSDL .

4
00: 00: 40, 950--> 00: 00: 49, 980
Và việc tái cấu trúc CSDL có nghĩa là chia phiên bản CSDL chung thành nhiều phiên bản CSDL .

5
00: 00: 50, 460--> 00: 00: 59, 910
Việc chia CSDL chung này thành nhiều phiên bản CSDL không đơn giản. Có nhiều thách thức.

6
00: 01: 00, 240--> 00: 01: 21, 090
Tôi sẽ thảo luận về một số thách thức này trong phần này và tôi cũng sẽ thảo luận về các giải pháp dưới dạng tùy chọn kỹ thuật, cũng như các mẫu dữ liệu nhất định có thể được sử dụng để thiết kế các vi dịch vụ mới và để chuyển đổi các ứng dụng nguyên khối hiện có sang các vi dịch vụ .
...
Cơ sở dữ liệu bền vững và chia sẻ trong bài giảng này, trước tiên tôi sẽ nói về mẫu CSDL dùng chung và sau đó thảo luận về ưu và nhược điểm của CSDL dùng chung, các ứng dụng cần phải tồn tại.

2
00: 00: 13, 320--> 00: 00: 24, 360
Dữ liệu, tính bền vững của dữ liệu này đạt được bằng cách ghi vào hệ thống tệp hoặc phổ biến hơn là bằng cách ghi dữ liệu vào CSDL .

3
00: 00: 24, 570--> 00: 00: 34, 650
Hiện nay có nhiều loại CSDL, nhưng CSDL được sử dụng phổ biến nhất là CSDL quan hệ và không có CSDL đơn lẻ.

4
00: 00: 34, 920--> 00: 00: 47, 970
Các ứng dụng kế thừa thường sử dụng RDBMS hoặc CSDL quan hệ cho tất cả các loại dữ liệu và đó là do không có CSDL đơn lẻ nào không có sẵn cho đến đầu những năm 2000.

5
00: 00: 48, 400--> 00: 01: 01, 320
Mẫu phát triển ứng dụng máy chủ khách điển hình được các ứng dụng cũ này sử dụng bao gồm nhiều ứng dụng doanh nghiệp chia sẻ một phiên bản chung của CSDL .

6
00: 01: 01, 920--> 00: 01: 16, 380
Tất cả dữ liệu miền được quản lý tập trung trong CSDL dùng chung này và ứng dụng doanh nghiệp sẽ quản lý dữ liệu bằng các câu lệnh tiếp theo đối với CSDL dùng chung này.
...
Điều đầu tiên là nó sẽ dẫn đến một quy trình quản lý dữ liệu được đơn giản hóa. Thứ hai là do công cụ CSDL được chia sẻ bởi nhiều ứng dụng nên chi phí của giải pháp sẽ giảm xuống.

9
00: 01: 37, 500--> 00: 01: 45, 660
Và thứ ba là một nhóm quản trị viên CSDL có thể quản lý CSDL cho tất cả các ứng dụng.

10
00: 01: 46, 140--> 00: 01: 56, 670
Bây giờ chúng ta hãy cùng vượt qua các thử thách với mẫu CSDL dùng chung. Thách thức đầu tiên là những thay đổi về CSDL cần phải được quản lý rất cẩn thận.

11
00: 01: 57, 240--> 00: 02: 12, 210
Hãy xem xét tình huống trong đó ứng dụng yêu cầu thay đổi lược đồ CSDL . Bây giờ chủ sở hữu ứng dụng không thể tiếp tục và thực hiện thay đổi vì nó có thể ảnh hưởng đến ứng dụng B và ứng dụng C.
...
Hoặc tất cả điều này sẽ dẫn đến chi phí thay đổi cao. Nó sẽ dẫn đến rủi ro cao hơn vì việc thay đổi CSDL có thể dẫn đến việc phá vỡ các ứng dụng khác.

15
00: 02: 42, 780--> 00: 03: 03, 180
Và vào cuối ngày, điều này sẽ dẫn đến thời gian định giá lâu hơn. Thách thức thứ hai là một ứng dụng có thể tác động tiêu cực đến tất cả các ứng dụng khác và điều này có thể xảy ra nếu ứng dụng đó cố tình hoặc vô ý bắt đầu sử dụng nhiều tài nguyên trên CSDL .

16
00: 03: 03, 390--> 00: 03: 15, 480
Hãy để tôi giải thích điều này bằng một ví dụ. Giả sử chúng ta có một CSDL dùng chung và có một ứng dụng báo cáo đã quyết định thực hiện một công việc tồi tệ.

17
00: 03: 15, 750--> 00: 03: 27, 740
Và công việc tồi tệ lớn này đang chiếm giữ rất nhiều tài nguyên trên CSDL dùng chung, chẳng hạn như bằng các truy vấn chạy dài hoặc bằng các truy vấn trả về lượng lớn dữ liệu.

18
00: 03: 28, 050--> 00: 03: 41, 840
Trong trường hợp này, mức sử dụng tài nguyên trên CSDL dùng chung sẽ tăng lên và các câu lệnh tiếp theo được thực thi bởi các ứng dụng khác là ứng dụng A, B và C sẽ bắt đầu bị ảnh hưởng.

19
00: 03: 41, 850--> 00: 03: 58, 970
Và loại suy giảm hiệu suất này đôi khi khó chẩn đoán vì mỗi ứng dụng chỉ xem nhật ký ứng dụng của chính chúng mà không biết rằng một số ứng dụng khác thực sự đang gây ra thách thức trên CSDL .

20
00: 03: 59, 730--> 00: 04: 10, 120
Tòa án thách thức rằng CSDL dùng chung hoạt động như một điểm lỗi duy nhất. Cơ sở dữ liệu bị lỗi sẽ dẫn đến lỗi của tất cả các ứng dụng.

21
00: 04: 10, 380--> 00: 04: 18, 350
Vì vậy, trong trường hợp này, nếu CSDL chia sẻ bị hỏng, tất cả các ứng dụng A, B và C sẽ không khả dụng.
...
Những thách thức khác là việc thực hiện lập kế hoạch năng lực cho CSDL dùng chung rất phức tạp vì các nhóm cần phối hợp để dự báo nhu cầu mà họ có.

24
00: 04: 45, 900--> 00: 04: 51, 900
Từ góc độ CSDL, các nhóm ứng dụng sẽ cần nhận thức được cấu trúc của dữ liệu.
...
Đầu năm 2000, kiến ​​trúc hướng dịch vụ đã trở thành một lựa chọn phổ biến để giải quyết các thách thức với CSDL dùng chung.
...
Đám mây là viết tắt của Tạo, Truy xuất, Đối tượng và xóa các dịch vụ đám mây này, ẩn các chi tiết về cấu trúc của CSDL khỏi các ứng dụng ngoài việc cung cấp các hoạt động dữ liệu cấp thấp này.

3
00: 00: 35, 130--> 00: 00: 48, 460
Vì vậy, các dịch vụ cũng có thể được xây dựng bằng cách đóng gói logic nghiệp vụ để cung cấp các dịch vụ cấp cao. Lớp dịch vụ xã hội được đặt giữa các ứng dụng và CSDL .
...
Lớp dịch vụ xã hội cung cấp nhiều lợi thế. Vì nó có cấu trúc của CSDL nên việc mã hóa và quản lý các ứng dụng trở nên đơn giản hơn nhiều.

7
00: 01: 19, 260--> 00: 01: 30, 630
Nó dẫn đến việc sử dụng lại mã thông qua các dịch vụ có thể tái sử dụng và những thay đổi đối với CSDL sẽ trở nên dễ quản lý hơn với lớp dịch vụ xã hội.

8
00: 01: 31, 320--> 00: 01: 46, 740
Nhưng thật không may, nó không giải quyết được nhiều thách thức về CSDL dùng chung khác, chẳng hạn như điểm lỗi duy nhất, việc sử dụng tài nguyên không được kiểm soát và tác động đến các ứng dụng khác cũng như ước tính dung lượng.

9
00: 01: 47, 740--> 00: 01: 58, 240
Ở điểm này, tôi muốn nêu ra một quan niệm sai lầm phổ biến, nhiều người cho rằng dịch vụ xã hội nhỏ là vi dịch vụ, nhưng điều đó không đúng.

10
00: 01: 58, 720--> 00: 02: 11, 230
Dịch vụ Azor không phải là một vi dịch vụ . Hãy suy nghĩ về nó như thế này. Một tập hợp các dịch vụ xã hội là một phần của các mối liên hệ gắn kết giống nhau, trong khi vi dịch vụ thể hiện một bối cảnh gắn kết.
...
Mẫu CSDL riêng biệt trong bài học này, tôi sẽ thảo luận về các sáng kiến ​​dịch vụ của Greenfield so với Greenfield Metro, sau đó tôi sẽ đi với một mẫu CSDL riêng biệt và những ưu điểm của nó.

2
00: 00: 12, 900--> 00: 00: 23, 880
Dự án Dịch vụ Vi mô Các dự án lĩnh vực xanh của Flavor là những dự án cần tạo ra một ứng dụng mới với kiến ​​trúc vi dịch vụ .

3
00: 00: 24, 180--> 00: 00: 38, 550
Và không có ràng buộc nào từ góc độ nợ kỹ thuật, trong khi Dự án Brownfield là một dự án trong đó ứng dụng nguyên khối hiện có cần được chuyển đổi sang kiến ​​trúc vi dịch vụ .
...
Nhóm vi dịch vụ này sẽ làm việc độc lập với nhau để đưa ra quyết định về cách triển khai các vi dịch vụ này.
...
Họ sẽ quyết định các giao diện khác nhau mà họ sẽ hiển thị cho các vi dịch vụ khác. Họ sẽ quyết định xem họ sẽ xuất bản để các vi dịch vụ khác sử dụng.

9
00: 01: 25, 170--> 00: 01: 35, 280
Bây giờ trọng tâm của chúng tôi ở đây là dữ liệu. Mỗi Microsoft sẽ sở hữu dữ liệu riêng của mình và sẽ không cho phép các vi dịch vụ khác truy cập trực tiếp vào dữ liệu.

10
00: 01: 35, 310--> 00: 01: 51, 070
Tất cả dữ liệu sẽ được chia sẻ bằng các giao diện được xác định rõ ràng. Vì vậy, nói cách khác, mỗi máy chủ vi mô sẽ có phiên bản CSDL riêng và do đó sẽ không gặp những thách thức giống như CSDL dùng chung.

11
00: 01: 51, 960--> 00: 02: 01, 610
Mẫu này trong đó mỗi chủ sở hữu và người quản lý nhóm vi dịch vụ có CSDL riêng của họ được gọi là mẫu CSDL riêng biệt.

12
00: 02: 01, 740--> 00: 02: 09, 340
Chúng ta hãy xem qua một số ưu điểm của mẫu này với mẫu CSDL . Việc quản lý thay đổi trở nên đơn giản hơn.

13
00: 02: 09, 530--> 00: 02: 25, 140
Mọi thay đổi đối với CSDL sẽ được cách ly với dịch vụ MICROS sở hữu CSDL . Vì vậy, trong trường hợp này, giả sử nếu Microsoft đang thực hiện một số thay đổi nào đó trong CSDL thì sẽ không có tác động trực tiếp đến vi dịch vụ .

14
00: 02: 25, 140--> 00: 02: 37, 790
A và B nhớ lại rằng trong trường hợp CSDL dùng chung, phiên bản CSDL là một điểm lỗi trong trường hợp mẫu CSDL riêng biệt.

15
00: 02: 38, 240--> 00: 02: 52, 920
Cơ sở dữ liệu không phải là một điểm lỗi duy nhất ở đây. Trong ví dụ này, nếu có vấn đề trong CSDL của Microsoft thì chỉ có Microsoft có a mới không khả dụng hoặc sẽ gặp thách thức.

16
00: 02: 53, 190--> 00: 03: 10, 440
Microsoft cho biết B và C có thể không có bất kỳ tác động trực tiếp nào do phiên bản CSDL của Microsoft bị lỗi nên mỗi nhóm có thể độc lập thực hiện việc lập kế hoạch năng lực của riêng mình cho CSDL vì không có sự phụ thuộc lẫn nhau.

17
00: 03: 10, 710--> 00: 03: 24, 370
Ngoài ra, việc mở rộng cấp độ CSDL trở nên đơn giản hơn nhiều so với phiên bản CSDL dùng chung. Mỗi nhóm có thể quyết định độc lập về công nghệ CSDL mà họ sẽ sử dụng.

18
00: 03: 24, 960--> 00: 03: 32, 310
Vì vậy, trong ví dụ này, chúng ta thấy rằng mỗi nhóm nghiên cứu của Microsoft đã quyết định sử dụng một CSDL khác nhau.

19
00: 03: 32, 490--> 00: 03: 41, 550
Điều này được gọi là tính bền bỉ đa ngôn ngữ, trong đó các nhóm trong cùng một doanh nghiệp đang sử dụng các công nghệ CSDL khác nhau.

20
00: 03: 42, 270--> 00: 03: 55, 280
Hãy cùng chuyển sang điểm chính trong bài giảng này cho Greenfield, sáng kiến ​​của Microsoft. Microsoft khuyến nghị nhà thiết kế nên sử dụng mẫu CSDL riêng biệt trong mẫu này.
...
Trong bài giảng này, các sáng kiến ​​và CSDL sai trái sẽ tìm hiểu về các tùy chọn có sẵn để chuyển đổi các khối nguyên khối sai trái thành các vi dịch vụ .

2
00: 00: 10, 710--> 00: 00: 18, 540
Chúng ta cũng sẽ tìm hiểu lý do tại sao mẫu CSDL dùng chung được xem xét và phản đối trong bối cảnh các vi dịch vụ .
...
Một ứng dụng nguyên khối được nhắm mục tiêu tái cấu trúc thành nhiều vi dịch vụ . Ứng dụng nguyên khối này nhiều khả năng sẽ có một phiên bản CSDL, người thiết kế Microsoft Office sẽ có ba tùy chọn từ góc độ CSDL có thể đi với mẫu CSDL phần mềm trong mỗi Microsoft, sẽ có bảo hiểm, CSDL riêng hoặc chúng có thể giữ lại CSDL chung và tái cấu trúc CSDL hoặc thực hiện phân tách logic CSDL .
...
Vì vậy, ý tưởng ở đây là CSDL có rất nhiều sự phức tạp và việc chia CSDL thành nhiều CSDL có thể không phải là một nhiệm vụ đơn giản.

10
00: 02: 12, 690--> 00: 02: 26, 180
Vì vậy, một chiến lược chung mà nhiều người thực hiện để chuyển đổi ứng dụng brownfield sang các vi dịch vụ là chỉ cần giữ nguyên CSDL và chuyển đổi ứng dụng sang các vi dịch vụ .

11
00: 02: 26, 190--> 00: 02: 44, 280
Và ứng dụng sẽ trông như thế này. Nhưng đoán xem? Bây giờ chúng ta có một tập hợp các vi dịch vụ đang chia sẻ CSDL và do đó chúng sẽ gặp phải những thách thức tương tự như các ứng dụng chia sẻ phiên bản của CSDL .

12
00: 02: 44, 850--> 00: 02: 58, 620
Mẫu CSDL dùng chung trong bối cảnh vi dịch vụ được xem xét và phản proton. Và lý do là vì với CSDL dùng chung, các nhóm mất đi tính độc lập, phụ thuộc lẫn nhau.
...
Hãy để tôi giải thích điều tôi muốn nói. Chúng ta bắt đầu với một ứng dụng nguyên khối, chỉ tập trung vào phần ứng dụng của nó và giữ nguyên CSDL .
...
Dần dần, mỗi vi dịch vụ này sẽ được tái cấu trúc để sử dụng phiên bản CSDL của riêng chúng. Vì vậy, trong sơ đồ này, CSDL dùng chung chỉ được sử dụng làm trạng thái chuyển tiếp chứ không phải là trạng thái đích.

18
00: 04: 06, 880--> 00: 04: 18, 280
Bây giờ, một điểm quan trọng cần lưu ý về mẫu CSDL dùng chung cho nghiên cứu của Microsoft là người dùng Microsoft không được có bất kỳ câu lệnh nào về phần tiếp theo trong mã.

19
00: 04: 19, 120--> 00: 04: 27, 260
Và lý do là việc có câu lệnh bằng nhau này trong code sẽ đòi hỏi nhiều nỗ lực hơn cho việc tìm kiếm CSDL .

20
00: 04: 27, 670--> 00: 04: 44, 760
Thay vào đó, Microsoft cho biết nhà thiết kế nên cân nhắc việc sử dụng chiến lược của kẻ bóp nghẹt trong chiến lược duy nhất là cố gắng cấp bằng sáng chế cho một tập hợp các dịch vụ được tạo ra để cung cấp quyền truy cập CSDL cho dịch vụ của Microsoft.

21
00: 04: 44, 950--> 00: 04: 54, 860
Mỗi vi dịch vụ được mô tả ở đây sẽ có bộ dịch vụ riêng. Các dịch vụ được gọi là dịch vụ của kẻ lạ mặt hoặc chỉ là người phân phối.

22
00: 04: 55, 090--> 00: 05: 02, 410
Ý tưởng đằng sau các dịch vụ này là việc tắt CSDL sẽ không ảnh hưởng đến các vi dịch vụ .

23
00: 05: 02, 530--> 00: 05: 15, 360
Vì tất cả những thay đổi sẽ được giới hạn trong các dịch vụ của kẻ lạ mặt. Các nhóm kinh doanh của Microsoft có thể quyết định các ưu tiên của mình và tìm kiếm CSDL theo tốc độ riêng của họ.

24
00: 05: 15, 370--> 00: 05: 26, 170
Và trong một khoảng thời gian, tất cả các vi dịch vụ sẽ có phiên bản CSDL riêng. Kết quả là kiến ​​trúc của mục tiêu sẽ đạt được.
...
Chúng ta hãy điểm qua những điểm chính trong bài giảng này, CSDL dùng chung. Pachon được coi là một phản proton từ góc độ nguồn của Microsoft.

32
00: 06: 31, 240--> 00: 06: 42, 790
Mẫu Strangler có thể được sử dụng để chuyển từ việc triển khai CSDL dùng chung của các vi dịch vụ sang triển khai CSDL riêng biệt của các vi dịch vụ .
...
Mẫu CSDL chia sẻ của các vi dịch vụ trong bài học này, tôi sẽ nói về mục tiêu và thách thức của việc chuẩn bị CSDL cho các vi dịch vụ .
...
Đầu tiên là tái cấu trúc CSDL và phân tách CSDL logic. Xin lưu ý rằng cuộc thảo luận trong bài giảng này chỉ áp dụng cho CSDL quan hệ.

4
00: 00: 29, 010--> 00: 00: 46, 740
Mặc dù mẫu CSDL dùng chung được coi là Antipater trong bối cảnh các vi dịch vụ, nhưng có thể đôi khi các nhóm vi dịch vụ sẽ không linh hoạt sử dụng mẫu CSDL riêng biệt và có thể có nhiều lý do dẫn đến việc đó.

5
00: 00: 47, 130--> 00: 01: 02, 310
Dưới đây là một số lý do phổ biến mà tôi thấy được trích dẫn vì không sử dụng CSDL riêng biệt. Hạn chế về thời gian, hạn chế về ngân sách, thiếu nguồn lực quy mô và sự phức tạp của CSDL là một số lý do phổ biến nhất.

6
00: 01: 02, 580--> 00: 01: 30, 650
Và vì vậy trong kịch bản, các nhóm phải xem xét mẫu CSDL dùng chung. Khi sử dụng CSDL dùng chung, mục tiêu của nhà thiết kế Microsoft là đạt được sự cách ly dữ liệu tối đa trong cùng một phiên bản CSDL sao cho mỗi phần dữ liệu của Microsoft trong CSDL và mỗi dịch vụ của Microsoft chỉ có quyền truy cập trực tiếp vào dữ liệu mà nó sở hữu. .

7
00: 01: 30, 780--> 00: 01: 43, 720
Nếu có thể, nhà thiết kế của Microsoft nên sử dụng các tính năng CSDL để đạt được mức độ cách ly cao nhất giữa Microsoft cho biết, về dữ liệu trong phiên bản CSDL .

8
00: 01: 44, 310--> 00: 01: 50, 980
Hãy nói về những thách thức khi phá vỡ CSDL . Cơ sở dữ liệu lớn không dễ tách rời.
...
Nhưng đó không phải là nơi bài tập sẽ kết thúc. Chúng ta cần xem xét dữ liệu được chia sẻ trên các vi dịch vụ, mối quan hệ giữa các bảng và các cột, các quy trình có thể có các câu lệnh tiếp theo được tham chiếu đến nhiều bảng trên CSDL .
...
Tùy chọn đầu tiên là sử dụng tái cấu trúc CSDL theo phương pháp này. Các thay đổi được thực hiện đối với CSDL cơ bản.
...
Xác định tái cấu trúc CSDL đã được Scott W. giới thiệu và quảng bá như trong cuốn sách Tái cấu trúc CSDL của họ.

17
00: 03: 22, 410--> 00: 03: 32, 750
Tái cấu trúc CSDL được định nghĩa là một thay đổi nhỏ đối với CSDL, giúp cải thiện thiết kế của nó mà không thay đổi ngữ nghĩa của nó.

18
00: 03: 33, 030--> 00: 03: 50, 190
Bây giờ, mục đích của việc tái cấu trúc CSDL khá khác so với những gì chúng tôi đang cố gắng đạt được ở đây. Tuy nhiên, thực tiễn được thảo luận trong cuốn sách này hoàn toàn có thể áp dụng được về mặt tối ưu hóa thiết kế CSDL để sử dụng từ nhiều vi dịch vụ .

19
00: 03: 51, 000--> 00: 03: 59, 130
Những thay đổi được thực hiện đối với CSDL như một phần của bài tập tái cấu trúc DB có thể được xếp vào một trong sáu danh mục.
...
Và mỗi bảng này thuộc sở hữu của một vi dịch vụ khác nhau. Loại thay đổi tiếp theo là thay đổi về kiến ​​trúc, là thay đổi áp dụng cho phương pháp về cách ứng dụng tương tác với CSDL .

22
00: 04: 31, 860--> 00: 04: 40, 740
Tiếp theo là những thay đổi về tính toàn vẹn tham chiếu ở đây. Mối quan hệ giữa các đối tượng CSDL được thay đổi.
...
Tiếp theo là phép biến đổi, là những thay đổi được áp dụng cho lược đồ CSDL . Và điều cuối cùng là chất lượng dữ liệu trong đó các thay đổi được áp dụng để cải thiện chất lượng dữ liệu.

26
00: 05: 16, 200--> 00: 05: 23, 640
Dưới đây là một ví dụ về tái cấu trúc cấu trúc trong đó CSDL được thiết kế lại để có nhiều lược đồ.

27
00: 05: 24, 030--> 00: 05: 31, 540
Mỗi lược đồ này sẽ được bảo vệ bằng các cơ chế kiểm soát truy cập có sẵn trong CSDL .
...
Hãy thảo luận về tùy chọn số hai, phân tách hợp lý CSDL trong tùy chọn này, không có thay đổi thiết kế nào được thực hiện đối với CSDL .

35
00: 06: 51, 950--> 00: 07: 03, 410
Cơ sở dữ liệu được phân tách một cách hợp lý thành các nhóm bảng và mỗi nhóm bảng được sở hữu và quản lý bởi một vi dịch vụ trong kiểu thiết lập này.

36
00: 07: 03, 560--> 00: 07: 19, 040
Các nhóm được kỳ vọng sẽ có tính kỷ luật cao. Ý tưởng là mỗi nhóm sẽ cần đảm bảo rằng họ chỉ truy cập trực tiếp vào dữ liệu của riêng mình và không truy cập trực tiếp vào dữ liệu của các dịch vụ metro khác.
...
Điều này không loại bỏ tất cả các thách thức liên quan đến CSDL dùng chung nhưng nó cung cấp một cách để kiểm soát quyền sở hữu dữ liệu của mỗi Microsoft.
...
Chúng ta nên sử dụng một mẫu CSDL riêng biệt mà mỗi mẫu của Microsoft sẽ có phiên bản CSDL riêng.
...
Chúng ta sẽ cần xem xét công nghệ, độ phức tạp, kỹ năng mà chúng ta có trong nhóm vi dịch vụ .
...
Nhược điểm của CSDL riêng biệt trong bài học này, tôi sẽ đề cập đến những thách thức liên quan đến nhiều CSDL trên các vi dịch vụ .
...
Nhược điểm đầu tiên của mẫu CSDL riêng biệt là chi phí tổng thể của giải pháp xét từ góc độ CSDL sẽ tăng lên.

4
00: 00: 35, 310--> 00: 00: 45, 630
Có hai yếu tố góp phần vào chi phí từ góc độ CSDL . Đầu tiên là nhu cầu cấp phép ngày càng tăng và nhu cầu về phần cứng ngày càng tăng.

5
00: 00: 45, 780--> 00: 00: 57, 690
Chúng ta sẽ cần nhiều máy chủ hơn, nhiều bộ nhớ hơn, nhiều mạng hơn để xây dựng nhiều CSDL . Yếu tố thứ hai liên quan đến nhu cầu vận hành và bảo trì.
...
Chỉ cần nhìn vào hình minh họa này, chúng ta có thể ước tính chi phí CSDL sẽ tăng gấp ba lần.

8
00: 01: 17, 070--> 00: 01: 30, 240
Hãy thảo luận về những cách mà chúng ta có thể giải quyết một số thách thức liên quan đến chi phí cao hơn này. Chúng ta có thể sử dụng CSDL nguồn mở thay vì phần mềm được cấp phép như của Oracle và Sequel.
...
Người ta có thể sử dụng một con ngựa dùng chung cho nhiều phiên bản CSDL . Bằng cách này, tổng chi phí về khả năng tính toán cho CSDL sẽ giảm xuống.

11
00: 01: 55, 620--> 00: 02: 08, 610
Một cách rất phổ biến để giải quyết mối lo ngại về chi phí là áp dụng CSDL gốc trên đám mây. Ý tưởng ở đây là nhiều nhà cung cấp đám mây ngày nay đang cung cấp CSDL dưới dạng dịch vụ.
...
Nhược điểm tiếp theo của mẫu CSDL này là hiệu suất truy vấn có thể bị giảm do phân phối dữ liệu.

14
00: 02: 36, 240--> 00: 02: 58, 290
Hãy xem xét ví dụ này khi Microsoft CE cần dữ liệu từ Microsoft và Microsoft đã bị đánh bại. Trong trường hợp này, tòa án mà Microsoft CE sẽ cần tập hợp lại là nơi lấy dữ liệu từ nó bằng cách gọi một API và sau đó Microsoft có thể thực thi phần tiếp theo để lấy dữ liệu từ CSDL .

15
00: 02: 58, 440--> 00: 03: 18, 000
Sau đó, tòa án và Microsoft CE sẽ lấy dữ liệu từ B bằng cách gọi API trên P của Microsoft, từ đó sẽ gọi ra tuyên bố tiếp theo đối với CSDL sau khi lấy dữ liệu từ B, mã Microsoft C sẽ cần hợp nhất dữ liệu từ đó. A và B.
...
Giả sử có Microsoft Office và Microsoft Office. B, mỗi vi dịch vụ này đều có CSDL riêng.
...
B, hãy coi nó như việc thực hiện thao tác chèn, cập nhật hoặc xóa phần tiếp theo trên CSDL của B. B sẽ hoạt động như một nguồn cân bằng và nó sẽ hoạt động như một người tiêu dùng.
...
Microsoft có quyền đối với dữ liệu nhận được từ B trong CSDL của chính mình dưới dạng bản sao chỉ đọc. Không có thư viện nào được thực thi đối với Microsoft nếu nó có thể gọi câu lệnh bằng nhau này đối với CSDL cục bộ để tạo phản hồi cho các truy vấn này.
...
Chúng ta sẽ được học về những bằng sáng chế này trong các bài giảng sau. Nhược điểm tiếp theo của mẫu CSDL như vậy là.

25
00: 04: 59, 980--> 00: 05: 15, 260
Sự phức tạp trong việc quản lý tính toàn vẹn dữ liệu và giao dịch. Hãy để tôi giải thích điều này bằng một ví dụ. Giả sử có một cửa hàng mua sắm trực tuyến đang sử dụng kiến ​​trúc vi dịch vụ và khách hàng đặt hàng.

26
00: 05: 15, 730--> 00: 05: 23, 520
Các đơn đặt hàng, dịch vụ của Miko, nhà xuất bản và thậm chí và có hai vi dịch vụ đang đăng ký các sự kiện này.
...
Nhưng trong cuộc thảo luận này, hãy giả sử rằng do một số vấn đề trên CSDL nên dịch vụ vận chuyển không thành công.
...
Nhưng thật không may, khách hàng này sẽ không bao giờ nhận được hàng. Nếu chúng ta xây dựng một hệ thống sử dụng CSDL dùng chung, giao dịch cục bộ có thể được sử dụng để tránh lỗi như vậy.
...
Đây là cách nó sẽ hoạt động. Giả sử một vi dịch vụ đã nhận được một giao dịch và nó đã cập nhật thành công giao dịch đó trong CSDL cục bộ.

34
00: 06: 28, 810--> 00: 06: 36, 310
Sau đó, nó xuất bản một sự kiện được nhận bởi một vi dịch vụ khác thực hiện cập nhật trạng thái cục bộ.

35
00: 06: 36, 460--> 00: 06: 42, 580
Và trình tự sẽ tiếp tục cho đến khi tất cả các vi dịch vụ liên quan đến giao dịch đều thành công.

36
00: 06: 42, 610--> 00: 06: 51, 190
Bây giờ, đây là một tình huống trong ngày nắng đẹp khi tất cả các vi dịch vụ đều cập nhật thành công trạng thái nội bộ của chúng trong CSDL .

37
00: 06: 51, 580--> 00: 07: 04, 780
Hãy xem xét một tình huống trong đó một trong các máy chủ vi mô sẽ bị lỗi. Giả sử khi nhận được sự kiện, hãy cố gắng xử lý nó nhưng không cập nhật được trạng thái nội bộ của nó trong CSDL .

38
00: 07: 04, 960--> 00: 07: 20, 320
Trong trường hợp này, C sẽ thông báo cho các vi dịch vụ khác bằng cách xuất bản một sự kiện và B khi nhận được lỗi, thậm chí từ C sẽ cập nhật trạng thái nội bộ của chúng bằng cách khôi phục giao dịch.
...
Đã đến lúc điểm lại những điểm chính của bài giảng này. Chi phí cao của các vi dịch vụ với CSDL riêng biệt có thể được giải quyết bằng cách sử dụng CSDL gốc trên nền tảng đám mây và nguồn mở.
...
Hãy xem xét tình huống trong đó một vi dịch vụ hiển thị một API, giả sử có nhiều người tiêu dùng API này, điều đó đúng.

2
00: 00: 10, 740--> 00: 00: 23, 210
Nói cách khác, các lệnh gọi API đang dẫn đến rất nhiều phần tiếp theo được chèn và xóa. Việc thực thi trên CSDL, trong khi người tiêu dùng B và C rất nặng.

3
00: 00: 23, 220--> 00: 00: 32, 760
Nói cách khác, phần lớn các lệnh gọi API đang dẫn đến các lệnh gọi chọn tiếp theo trên phiên bản CSDL .

4
00: 00: 32, 950--> 00: 00: 44, 340
Bây giờ, giả sử trong một khoảng thời gian, tải từ người tiêu dùng này bắt đầu tăng lên. Vì vậy, để giải quyết tải bổ sung, nhóm vi dịch vụ Macario sẽ mở rộng quy mô phiên bản.

5
00: 00: 44, 550--> 00: 00: 52, 830
Bây giờ, điều này sẽ giúp CSDL có thể xử lý lưu lượng truy vấn từ tất cả các phiên bản.

6
00: 00: 53, 010--> 00: 01: 03, 780
Điều gì sẽ xảy ra nếu tải truy vấn từ các phiên bản vượt quá truy vấn tối đa mà CSDL có thể xử lý thì CSDL sẽ trở thành nút cổ chai.

7
00: 01: 04, 470--> 00: 01: 17, 850
Một kỹ thuật phổ biến được sử dụng để giải quyết tắc nghẽn CSDL là tách phiên bản CSDL thành các phiên bản CSDL được tối ưu hóa và đọc được tối ưu hóa phù hợp.

8
00: 01: 18, 060--> 00: 01: 33, 030
Trên thực tế, việc thấy nhiều trường hợp trong các ứng dụng quy mô lớn là điều rất bình thường. Xin lưu ý rằng việc tách CSDL này khác với mẫu CSDL Sopra dành cho các vi dịch vụ .

9
00: 01: 33, 880--> 00: 01: 48, 880
Giờ đây, cơ chế tách CSDL thành các phiên bản được tối ưu hóa đọc và ghi này sẽ hoạt động miễn là tính toàn vẹn của dữ liệu được duy trì trên nhiều phiên bản của CSDL .

10
00: 01: 49, 030--> 00: 02: 01, 710
Nói cách khác, khi dữ liệu được ghi vào CSDL được tối ưu hóa phù hợp, dữ liệu đó sẽ được phản ánh nhất quán trên tất cả các bản sao của CSDL được tối ưu hóa việc đọc.
...
Bước đầu tiên, chúng ta sẽ tạo một phiên bản của CSDL PostgreSQL. Chúng ta không chỉ sử dụng phiên bản CSDL này trong bài giảng này mà còn trong các bài giảng sau này, chúng ta sẽ sử dụng CSDL như một dịch vụ có tên là phần tiếp theo của LFN để tạo mọi phiên bản của CSDL .
...
Chúng tôi sẽ sử dụng phiên bản khác của CSDL trên phần tiếp theo của voi dot com. Vì vậy, hãy tiếp tục và tạo CSDL .

8
00: 01: 34, 230--> 00: 01: 50, 640
Vào trang con voi liềm dot com, nhấp vào đăng nhập, sau đó nhấp vào Đăng ký tại đây. Chúng ta sẽ cung cấp địa chỉ email của mình, chúng ta sẽ nhận được email từ voi bằng dot com kèm theo liên kết để thiết lập tài khoản.
...
Chúng ta sẽ thấy một CSDL khác. Những gì chúng ta sẽ làm là xóa CSDL mặc định đó bằng cách nhấp vào chỉnh sửa.
...
Chúng tôi sẽ tạo một ví dụ. Vì vậy hãy nhấp vào tạo phiên bản mới, cung cấp tên của CSDL . Tôi sẽ gọi nó là Rắc rối Achmat.
...
Đối với tôi, đó là Northern Virginia Review và sau đó giúp tạo instance. Và đây là ví dụ của chúng tôi bây giờ. Vì vậy, bây giờ chúng ta có một phiên bản của CSDL Postgres sẽ được sử dụng cho bước thử nghiệm tiếp theo của chúng ta.
...
Là Đối tượng Bộ kết quả JBC và điều này nhằm đơn giản hóa mọi thứ cho những người không quen thuộc với JDBC để kiểm tra lớp dựa trên Geremek, chúng tôi sẽ sử dụng lớp kiểm tra báo cáo GETBACK chỉ đơn giản là mở rộng lớp dựa trên JDBC và thực thi một số câu lệnh của phần tiếp theo đối với bảng chúng tôi đã tạo trên phiên bản CSDL Postgres của mình.
...
Từ góc độ triển khai, điều đầu tiên chúng ta làm là tạo kết nối, tạo câu lệnh school, sau đó thực thi câu lệnh bằng này, chuyển đổi các kết quả nhận được từ CSDL sang Jason bằng cách sử dụng lớp tiện ích JDBC ResultSet sang Jason.
...
Chúng ta cần sao chép số báo cáo, theo mặc định là năm, bốn, ba, hai. Vì vậy không nên thay đổi.
...
Nó lấy tên và tuổi làm tham số gọi việc thực thi phần tiếp theo và đó là cách nó được chèn vào bảng CSDL .
...
Ackerman ghi vào CSDL và truy vấn sẽ đọc từ CSDL . Trước khi lệnh ghi vào CSDL, nó cần dịch từ đối tượng mô hình miền chung sang ngôn ngữ mà CSDL hiểu được.
...
Tương tự, khi truy vấn được đọc, dữ liệu từ CSDL sẽ chuyển đổi từ biểu diễn CSDL sang biểu diễn đối tượng mô hình miền chung trong ngữ cảnh truy vấn.
...
Nó thực thi logic nghiệp vụ và sau đó chuyển đổi mô hình thành biểu diễn CSDL và sau đó ghi CSDL .
...
Sau đó, nó lấy dữ liệu từ CSDL, chuyển đổi dữ liệu phản hồi thành mô hình miền rồi gửi lại cho người gọi truy vấn.

14
00: 02: 22, 320--> 00: 02: 32, 490
Một điểm cần lưu ý là trong một hệ thống điển hình, mô hình LeDroit chung và CSDL trình đọc chung được sử dụng cho cả lệnh và truy vấn.
...
Người thiết kế vi dịch vụ cần suy nghĩ về chỉ mục, nhu cầu tạo trong CSDL . Thách thức của việc lập chỉ mục là nó dẫn đến tác động tiêu cực đến việc thực hiện quyền không có hệ thống chính thức.
...
Trưởng nhóm EITE trong nhóm bán hàng Acme đã quyết định thành lập nhóm quân trong nhóm quân này. Anh ấy muốn tạo một lệnh sẽ tạo đề xuất cho khách hàng trong CSDL và anh ấy muốn tập hợp một số truy vấn phổ biến đối với các đề xuất đó và anh ấy quyết định giữ cho lệnh này linh hoạt cho các truy vấn trong tương lai.
...
Nhưng chúng ta hãy xem Dikili triển khai lệnh và truy vấn như thế nào. Có hai bảng quan tâm trong CSDL này.
...
Tiếp theo sẽ tiếp tục và tạo bảng trong CSDL bằng cách sử dụng tập lệnh có sẵn trong thư mục phần tiếp theo.
...
Có hai lớp lệnh kiểm tra và truy vấn kiểm tra. Sau khi ra tòa, chúng tôi sẽ thực thi lệnh kiểm tra để xem đề xuất được tạo trong CSDL và khi chạy truy vấn kiểm tra, chúng tôi sẽ có thể truy vấn các đề xuất.
...
Tương tự, có một lớp kho lưu trữ đề xuất mở rộng CSDL và triển khai giao diện đề xuất trong lớp này.
...
Chúng tôi chỉ đơn giản là tạo một phiên bản của kho đề xuất và sau đó thêm đề xuất vào CSDL bằng cách gọi kho đề xuất.
...
Ý tưởng này được đề xuất bởi Greg Young. Chúng ta có thể đọc thêm về nó tại đây. Chúng ta là một định nghĩa chính thức hơn về chứng khoán yêu cầu trách nhiệm.
...
Để đọc và ghi các mô hình có thể sử dụng phiên bản chung của kho dữ liệu. Điều này có thể dẫn đến mất khả năng tối ưu hóa CSDL để đọc và ghi.
...
Không chỉ vậy, tùy thuộc vào trường hợp sử dụng cho bên đọc và bên phải, các công nghệ CSDL khác nhau có thể sử dụng các công nghệ CSDL khác nhau trong cùng một miền đôi khi được gọi là tính bền vững đa ngôn ngữ.

14
00: 02: 30, 030--> 00: 02: 49, 200
Đây là một ví dụ về lý do tại sao nên sử dụng các công nghệ CSDL khác. Giả sử yêu cầu đối với trang web phù hợp là phải có thuộc tính tài sản cho các giao dịch và mong muốn là không nên tạo bộ chỉ mục nào trên các bảng CSDL để đạt được thông lượng cao cho trang web bên phải.

15
00: 02: 49, 200--> 00: 03: 07, 380
Và ở phía bên phải, giả sử yêu cầu là phải có các truy vấn mối quan hệ có hiệu suất cao. Trong trường hợp này, các nhà phát triển có thể quyết định sử dụng CSDL RDBMS ở bên phải và CSDL đồ thị trên trang đọc.
...
Hoặc nếu điều đó vẫn chưa đủ thì họ có thể xem xét việc tạo bản sao trình đọc cho CSDL trình đọc hoặc sử dụng phân đoạn.
...
Trích dẫn ví dụ về các truy vấn như vậy là các truy vấn văn bản miễn phí và báo cáo từ nhiều nguồn dữ liệu. Trong trường hợp này, cùng loại CSDL ở bên phải sẽ không thể xử lý hiệu quả tất cả các loại truy vấn khác nhau.
...
Loại cơ chế này được hỗ trợ cho nhiều CSDL khu vực như Postgrads, Equal Mass, Equal SQL Server và Oracle.
...
Chúng ta có thể sử dụng các công nghệ thu thập dữ liệu theo chuỗi cho phép chúng ta nắm bắt các thay đổi trong một kho dữ liệu và cập nhật kho dữ liệu khác.

13
00: 02: 25, 980--> 00: 02: 38, 550
Chúng ta có thể sử dụng ứng dụng gốc như Amazon. A.W. có bản sao Artigas MySQL. Chúng ta có thể sử dụng các công cụ của bên thứ ba như Click và A.W. là dịch vụ di chuyển dữ liệu.
...
Trong bài học này, chúng ta sẽ mở rộng việc triển khai trong đề xuất tạo. Lệnh sẽ không chỉ chèn đề xuất vào CSDL mà còn xuất bản và thậm chí là một chủ đề trên Rabbitt MQ vì phía đọc sẽ khác với phía bên phải trong quá trình triển khai này về sau.
...
Có một lệnh kiểm tra lớp mới phiên bản hai thực thi lệnh tạo đề xuất và nó sẽ dẫn đến việc chèn một mũi tên và CSDL Postgres, đồng thời xuất bản thông báo chẵn trên Q, phiên bản hai của Lệnh Tạo đề xuất mở rộng phiên bản một của lệnh tạo đề xuất.
...
Các chế độ xem ở đây không phải là chế độ xem CSDL quan hệ, đây là các chế độ xem dữ liệu cần thiết cho người tiêu dùng trang web.
...
Vậy thì không phải là câu hỏi. Có nên sử dụng nước sốt đều không? Và câu trả lời là nó phụ thuộc vào trường hợp sử dụng. Chúng ta cần đánh giá trường hợp sử dụng của mình từ góc độ lợi ích tìm nguồn cung ứng đồng đều.
...
Thiết lập Mongo DB ở phía bên phải trong bài học này, chúng ta sẽ tạo một phiên bản của CSDL Modiba trên cloud dot, mongo DB dot com.
...
Xin lưu ý rằng mục đích của tôi trong bài học này không phải là dạy Mongo DB về mã này. Chúng ta không cần phải biết Mongo DB.
...
Dot com là nhà cung cấp CSDL dưới dạng dịch vụ cho Mongo DB. Để tạo một phiên bản, chỉ cần truy cập cloud dot mongo db dot com.
...
Gọi tất cả và cung cấp tên cụm. Tôi sẽ gọi cụm này là rắc rối ackmann. Chúng ta không cần phải tạo cụm nếu chúng ta đã nhấp chuột vào Tạo cụm và sẽ mất vài phút để tạo cụm.
...
Vì vậy hãy đến với cụm bấm vào bộ sưu tập. Bây giờ ở đây trong cụm, chúng tôi sẽ thêm CSDL của riêng mình. Và để làm điều đó, chỉ cần nhấp vào Thêm dữ liệu của riêng tôi.

20
00: 03: 07, 480--> 00: 03: 16, 960
Hãy đặt tên CSDL là Achmad Travel và tạo một bộ sưu tập thử nghiệm. Tôi sẽ chỉ gọi nó là test và chúng ta có một bộ sưu tập có tên test là bước tiếp theo.
...
Chúng tôi sẽ sử dụng Mongul trong mọi cuộc biểu tình, mở rộng lớp dựa trên Mongar DV, sau đó thực hiện thao tác chèn và tìm đối với bộ sưu tập thử nghiệm trong CSDL Akhmatova, lớp dựa trên Mông Cổ có sẵn và AKAM DOT hoặc Info Dot Mongo DB.

26
00: 04: 22, 180--> 00: 04: 46, 030
Chúng ta sẽ thấy rằng nó sử dụng máy khách Mongo DB. Có một tập hợp các biến chứa các tham số kết nối cho Mongo DB, chức năng chèn thực thi, chèn tài liệu liền kề và bộ sưu tập Mongo DB và hàm find tìm tập hợp các tài liệu phù hợp với tiêu chí đã chỉ định.
...
Vì vậy, bây giờ máy chủ của chúng tôi là tốt vào thời điểm này. Chúng tôi cần tạo một người dùng mới trong CSDL của mình để làm điều đó. Trong bảng điều hướng bên trái, nhấp vào truy cập CSDL và sau đó nhấp vào THÊM Cơ sở dữ liệu mới. Người dùng cung cấp tên ở đây sẽ gọi cho người dùng mà người dùng repro đã nói mật khẩu để giữ mọi thứ dễ dàng.
...
Người đăng ký sử dụng trình đọc đề xuất Rupo để thêm dữ liệu đề xuất vào bộ sưu tập CSDL . Để kiểm tra thiết lập, chúng tôi sẽ sử dụng thuê bao thử nghiệm, nó sẽ khởi chạy một phiên bản của thuê bao đề xuất để nhận tin nhắn từ Rabbitt MQ.
...
Chúng ta có thể tự mình xem qua mã này. Nó chỉ đơn giản là lấy các tài liệu từ Mongo DB và sau đó chuyển đổi các tài liệu này thành chuỗi liền kề trước khi tôi hướng dẫn chúng ta mã trong phần đăng ký.
...
Phía bên phải ghi dữ liệu vào CSDL của nó nhưng không thể đưa tin nhắn vào hàng đợi. Bây giờ phía đọc sẽ không bao giờ nhận được tin nhắn.

4
00: 00: 28, 380--> 00: 00: 42, 670
Kết quả là dữ liệu trên hai phiên bản CSDL hiện ở trạng thái không nhất quán. Loại mất dữ liệu này có thể được ngăn chặn bằng cách sử dụng mẫu tin nhắn đáng tin cậy trong mẫu này.
...
Những lần thử lại này có thể gây ra sự chậm trễ trong việc đạt được trạng thái dữ liệu nhất quán trên các phiên bản CSDL, nhưng cuối cùng dữ liệu sẽ nhất quán trên các phiên bản CSDL .
...
Đã đến lúc thực hiện một bài kiểm tra trong sơ đồ thành phần được thảo luận ở một trong những bài giảng trước đó, đối tượng lệnh đang ghi vào CSDL rồi xuất bản một thông báo lên một chủ đề.
...
Kết quả là nó sẽ không thể cập nhật CSDL và xuất bản tin nhắn. Mặc dù mạng luôn hoạt động nhưng máy chủ CSDL có thể gặp sự cố, có thể ngừng hoạt động hoặc có thể hết tài nguyên.

13
00: 02: 18, 570--> 00: 02: 30, 550
Và còn rất nhiều điều khác có thể xảy ra với CSDL . Tương tự, ngay cả khi mạng không hoạt động, đối tượng lệnh có thể không xuất bản được tin nhắn tới Amcu do máy chủ Amcu bị lỗi.
...
Vì vậy, chúng tôi sẽ tập trung vào vấn đề không có sẵn của Amcu. Trong trường hợp này, lệnh sẽ được gọi và lệnh sẽ có thể ghi vào CSDL, nhưng khi cố gắng xuất bản một tin nhắn lên Amcu thì sẽ không thành công.
...
Một cách để giải quyết lỗi này là ghi vào CSDL và xuất bản một thông báo tới AMCU trong một đơn vị công việc hoặc một giao dịch phải đối mặt.
...
Trong trường hợp này, tài nguyên là CSDL và bus AMCU. Thách thức với nhận xét Hai mặt là nó khá phức tạp để thực hiện và thách thức lớn hơn là nó thậm chí không có sẵn cho nhiều người được phân phối phổ biến.
...
Giải pháp thay thế là phá vỡ quyền CSDL và xuất bản MQ theo hai bước và sử dụng các giao dịch CSDL cục bộ.

28
00: 05: 29, 440--> 00: 05: 53, 920
Vì không có tên chung cho mẫu này nên tôi sẽ gọi nó là mẫu tin nhắn đáng tin cậy. Trong mẫu này, phía bên phải ghi dữ liệu đối tượng miền và dữ liệu sự kiện vào các bảng CSDL bằng một giao dịch cục bộ, sau đó các sự kiện được phát lại trên hệ thống xếp hàng trong một bước riêng biệt.

29
00: 05: 54, 190--> 00: 06: 20, 110
Hãy để tôi dẫn chúng ta đến một minh họa sẽ làm cho mô hình này trở nên rất rõ ràng. Chúng ta đã quen với hình minh họa này, trong đó Lệnh Đề xuất Creel đang ghi dữ liệu đề xuất vào CSDL và sau đó xuất bản một thông báo trong bước xử lý bài đăng để sử dụng mẫu thông báo đáng tin cậy đã khai báo lệnh đề xuất sẽ không còn xuất bản một thông báo tới MQ nữa.

30
00: 06: 20, 500--> 00: 06: 31, 240
Thay vào đó, chúng tôi sẽ giới thiệu một bảng mới trong CSDL cùng với các đề xuất. Bảng sẽ gọi bảng này là bảng chẵn.
...
Cuối cùng, việc xuất bản sẽ thành công và trạng thái của sự kiện sẽ được cập nhật và kết quả là CSDL sẽ được ngăn chặn, thậm chí mất mát.
...
Nó liên tục tìm kiếm các sự kiện chưa được xử lý trong CSDL . Vì vậy, điều đầu tiên nó làm là người gọi chọn hoặc tìm đối với CSDL để lấy tất cả các sự kiện chưa được xử lý.
...
Nhưng nếu nhà xuất bản thành công thì sự kiện sẽ được đánh dấu là đã xử lý trong CSDL . Sau khi tất cả các sự kiện chưa được xử lý đã được xuất bản, ngay cả Bộ xử lý cũng sẽ chuyển sang chế độ ngủ trong một thời gian và tiếp tục kiểm tra các sự kiện chưa được xử lý.
...
Tôi sẽ thảo luận về những thay đổi đã được thực hiện đối với phiên bản triển khai Securus. Khi họ xóa lệnh đề xuất sẽ được gọi, nó sẽ ghi vào các bảng CSDL, hai bảng robot sẽ là đề xuất, bảng của chúng và tải trọng chẵn.

7
00: 01: 22, 390--> 00: 01: 33, 850
Có bàn. Hai quyền này sẽ được thực hiện trong một giao dịch CSDL cục bộ. Vì vậy, điều đó có nghĩa là cả hai quyền sẽ thành công hoặc cả hai sẽ thất bại.
...
Nếu tìm thấy các sự kiện chưa được công bố, nó sẽ công bố các sự kiện đó lên bảng tin và sau đó cập nhật trạng thái của các sự kiện trong bảng CSDL như đã công bố.

11
00: 02: 09, 160--> 00: 02: 26, 170
Tuy nhiên, việc thiết lập tính năng không có sẵn tính năng nhắn tin này sẽ không dẫn đến việc bỏ lỡ sự kiện. Đây là cách bảng CSDL cho Even's sẽ trông như thế nào, chúng ta sẽ có Eventide và lời cầu hôn của người phụ nữ cầu hôn.
...
Chúng ta hãy xem nhanh nó. Chúng ta sẽ thấy rằng hầu hết mã trong sự kiện rõ ràng, phần tải trọng và phần tiếp theo là để tạo bản trình bày JSON của sự kiện.
...
Và lý do tôi làm điều đó là vì có những chuỗi bị mắc vào và điều đó sẽ gây ra vấn đề khi tôi nhập dữ liệu vào bảng CSDL .
...
Chúng ta sẽ tìm thấy ba lớp theo đề xuất. Lớp chẵn là mô hình cho dữ liệu trong đề xuất.
...
Ví dụ: quy trình có thể gặp sự cố hoặc có thể có sự cố trên máy lưu trữ quy trình. Mạng giữa bộ sao chép và CSDL có thể không khả dụng do bộ sao chép không thể truy cập CSDL và bản thân CSDL có thể gặp sự cố tổng thể.
...
Đầu tiên nó cố gắng ghi nó vào CSDL . Và nếu quyền CSDL thành công thì bộ sao chép sẽ xác nhận thông báo, điều này dẫn đến việc xóa thông báo khỏi ông chủ MQ trong trường hợp không sao chép được hoặc có thể từ chối thông báo.
...
Chúng ta chỉ cần lưu ý rằng đó là một khả năng có thể xảy ra, đặc biệt khi trình sao chép của chúng ta đã được biết đến trong một thời gian dài và có một lượng lớn thư được đưa vào hàng đợi.
...
Chúng ta có thể đọc thêm về điều đó sau, vì tại liên kết này dành cho Rabbitt MQ. Đôi khi sự thất bại ở phía bên phải có thể gây ảnh hưởng đến phía bên phải.

29
00: 05: 26, 270--> 00: 05: 39, 850
Hãy xem xét tình huống trong đó bộ xử lý chẵn có thể xuất bản thông báo tới Amcu, nhưng nó không thể cập nhật trạng thái của sự kiện trong CSDL khi được xử lý.
...
Nếu xuất bản thành công, nó sẽ được mua trước khi có thể cập nhật trạng thái của sự kiện trong CSDL .

33
00: 06: 12, 380--> 00: 06: 19, 540
Kết quả là CSDL đã hoạt động trở lại, khi bộ xử lý thậm chí cố gắng cập nhật CSDL thì không thành công.
...
Chà, cả hai bên nên cân nhắc đưa ra cách khắc phục, nhưng nếu tôi phải chọn một trong hai nhóm thì tôi sẽ nói rằng bên phải phải xử lý các sự kiện trùng lặp.
...
Một giải pháp đơn giản ở phía bên phải là bỏ qua các sự kiện trùng lặp hoặc khóa các sự kiện trùng lặp trong CSDL riêng biệt để điều tra thêm.
...
Thậm chí dữ liệu còn được đưa vào đề xuất, thậm chí còn ổn định. Và cả hai thao tác chèn này đều được thực hiện bằng giao dịch CSDL cục bộ.
...
Bộ xử lý chẵn liên tục kiểm tra CSDL để tìm các sự kiện chưa được công bố hoặc các sự kiện chưa được xử lý. Khi tìm thấy các sự kiện chưa được xử lý, nó sẽ lặp qua tập hợp các sự kiện chưa được xuất bản.

12
00: 02: 10, 890--> 00: 02: 22, 530
Đối với mỗi sự kiện, nó xuất bản sự kiện và sau đó cập nhật trạng thái của sự kiện trong CSDL . Việc đăng ký sự kiện được thực hiện ở phía đọc.
...
Nếu nó tồn tại thì sự kiện sẽ bị bỏ qua. Mặt khác, nó thậm chí còn được thêm vào bộ sưu tập được lưu trữ đồng đều cũng như được xử lý và thêm vào các bộ sưu tập khác trong CSDL REDECIDE trước khi chạy.
...
Kafka là một nền tảng phát trực tuyến cực kỳ phổ biến với các nhà thiết kế và phát triển vi dịch vụ, nhiều tính năng của Kavkaz trùng lặp với các khả năng được cung cấp bởi các nền tảng nhắn tin khác như Rabbit MQ và Active MQ.

2
00: 00: 18, 420--> 00: 00: 31, 170
Nhà thiết kế dịch vụ cần đưa ra quyết định về việc nên sử dụng tính năng phát trực tuyến Cafcass hay sử dụng nhà môi giới nhắn tin như Rabbitt MQ hoặc MQ hoạt động cho các vi dịch vụ của họ.

3
00: 00: 31, 260--> 00: 00: 44, 430
Để trả lời câu hỏi này, người thiết kế vi dịch vụ phải hiểu khả năng phát trực tuyến Cafcass so với khả năng được cung cấp bởi các nhà môi giới tin nhắn khác này.
...
Chúng ta hãy đi qua các mục tiêu học tập cho phần này. Chúng ta sẽ học các khái niệm chúng ta học. Sự khác biệt giữa Kafka và MGP sẽ được thảo luận.
...
Nó có khả năng mở rộng cao. Chúng ta có thể dễ dàng thêm nhiều máy hoặc nút môi giới vào cụm để mở rộng quy mô theo yêu cầu của mình. Cụm này có thể xử lý hàng nghìn tỷ tin nhắn mỗi ngày và có thể xử lý hàng petabyte dữ liệu, kho lưu trữ cụm Kafka, tất cả dữ liệu nhắn tin và bộ lưu trữ liên tục.
...
Chúng ta sẽ thấy có một chủ đề mặc định được tạo. Ví dụ: tên chủ đề là tên người dùng Dasch Default của chúng ta .
...
Bấm vào trình duyệt ở đây. Chúng ta cung cấp tên chủ đề. Chúng ta có thể sao chép nó từ các chủ đề. Bấm vào Tiêu thụ.
...
Ho, ho hoặc các vi dịch vụ trong bài giảng này nhấn mạnh các trường hợp sử dụng phổ biến của Kafka và sau đó chúng ta sẽ có một hoạt động thú vị trong hoạt động vui nhộn này.
...
Và dựa trên những yêu cầu này, chúng ta sẽ cần quyết định nền tảng nhắn tin của mình. Chúng ta sẽ chọn Casca hoặc Rabbitt MQ.
...
Chúng ta sẽ chọn gì, Robert MQ hay Kafka? Tôi sẽ chọn Rabbitt Amcu và lý do là lượng tin nhắn khá thấp.
...
Chúng ta sẽ chọn cái nào? Kafka hoặc. Abbi, cảm ơn chúng ta . Chà, tôi sẽ chọn Kafka vì có rất nhiều công cụ có sẵn cho Thời gian thực.
...
Chúng ta sẽ chọn cái nào trong kịch bản? Tôi sẽ chọn Rabbitt MQ. Đây là cách triển khai dựa trên tiêu chuẩn M cupie và có thể được thay thế bằng bất kỳ triển khai M QB nào khác, chẳng hạn như MQ hoạt động so với Kafka.
...
Chúng ta hãy đi qua các mục tiêu học tập cho phần này. Chúng ta học mô hình saga. Chúng ta sẽ tìm hiểu các loại mẫu Saagar.
...
Tính nhất quán trong các giao dịch của nhà phân phối trong một trong những bài giảng trước đó được tiết lộ cho Facebook, bài giảng này có thể được sử dụng để quản lý tính nhất quán của dữ liệu trong một CSDL duy nhất.

2
00: 00: 12, 960--> 00: 00: 19, 740
Nhưng trong trường hợp giao dịch phân tán, có thể có nhiều CSDL trên nhiều vi dịch vụ .
...
Nguyên tắc gợi ý rằng chúng ta nên luôn lường trước những thất bại sẽ xảy ra. Chúng ta nên chủ động xác định các điểm lỗi trong kiến ​​trúc của mình liên quan đến các thành phần phân tán hoặc vi dịch vụ, sau đó chúng ta nên giải quyết tất cả các điểm lỗi trong kiến ​​trúc của mình.

5
00: 00: 58, 440--> 00: 01: 17, 400
Đây là cách thực hành tốt nhất để xây dựng hệ thống phân tán. Ý tưởng là vì mỗi vi dịch vụ có CSDL riêng nên nếu không giải quyết được lỗi, điều đó sẽ dẫn đến trạng thái dữ liệu không nhất quán trên nhiều CSDL do vi dịch vụ sở hữu.
...
Khách hàng thanh toán cho đơn hàng. Dịch vụ ô tô chuyển đơn đặt hàng vào CSDL đơn đặt hàng và sau đó đưa ra một sự kiện mà dịch vụ thanh toán nhận được để xử lý thanh toán sau khi thanh toán được xử lý thành công, dịch vụ thanh toán sẽ thêm thông tin đơn hàng cùng với thông tin thanh toán của chính nó. CSDL .

8
00: 01: 50, 390--> 00: 02: 00, 230
Sau đó, dịch vụ vận chuyển sẽ được gọi. Dịch vụ vận chuyển cố gắng thêm thông tin đơn hàng và thông tin lô hàng vào CSDL của chính dịch vụ đó.
...
Người thiết kế hệ thống phân tán phải đảm bảo rằng dữ liệu nhất quán trên tất cả các dịch vụ phân tán hoặc vi dịch vụ .

13
00: 02: 40, 700--> 00: 02: 49, 060
Trở lại ví dụ về website thương mại điện tử. Điều này có nghĩa là đơn hàng phải được đánh dấu thành công trong cả ba CSDL .

14
00: 02: 49, 340--> 00: 03: 03, 770
Nếu xảy ra lỗi, giả sử CSDL lô hàng được thực hiện, lỗi đó sẽ dẫn đến thay đổi trạng thái và khoản thanh toán của CSDL khác sẽ được hoàn lại cho khách hàng và đơn hàng sẽ được đánh dấu là không thành công.

15
00: 03: 03, 980--> 00: 03: 15, 080
Khách hàng phải được thông báo hoặc dịch vụ đặt hàng phải được thử vào cuối ngày. Trạng thái của đơn hàng phải nhất quán trên cả ba CSDL .

16
00: 03: 15, 230--> 00: 03: 28, 400
Tất cả đều có thể thành công hoặc đều có thể thất bại, nhưng nó không thể là sự kết hợp giữa thành công và thất bại. Một điểm quan trọng cần ghi nhớ là các giao dịch cục bộ không thể được sử dụng để tránh trạng thái của CSDL .

17
00: 03: 28, 550--> 00: 03: 37, 880
Vì vậy, trong trường hợp này, dịch vụ thanh toán và đơn hàng hoặc dịch vụ không thể sử dụng các giao dịch CSDL cục bộ để khôi phục các thay đổi trong CSDL .

18
00: 03: 38, 930--> 00: 03: 50, 780
Saga Pattern cung cấp giải pháp quản lý tính nhất quán của dữ liệu trên các vi dịch vụ . Nó liên quan đến việc sử dụng các giao dịch địa phương cùng với các giao dịch bù đắp.

19
00: 03: 51, 230--> 00: 04: 08, 930
Hãy để tôi giải thích nó bằng một minh họa. Giả sử chúng ta có ba vi dịch vụ . Luồng giao dịch bắt đầu bằng việc gọi API trên CNTT của Microsoft, trong đó có giao dịch T1 được thực thi và đó là giao dịch cục bộ dựa trên CSDL .

20
00: 04: 08, 990--> 00: 04: 21, 710
Giao dịch này dẫn đến việc gửi một sự kiện được Microsoft nhận dưới dạng B và phản hồi lại Giao dịch B Thực thi T2 của Microsoft đối với CSDL cục bộ của nó.

21
00: 04: 21, 710--> 00: 04: 32, 970
T2 dẫn đến cuộc họp của sự kiện, được Microsoft nhận dưới dạng C và để đáp lại, Microsoft C thực thi Giao dịch D ba đối với CSDL cục bộ của nó.

22
00: 04: 32, 990--> 00: 04: 44, 740
Cho đến nay, mọi thứ vẫn ổn và dữ liệu có trạng thái không nhất quán trên cả ba CSDL . Lúc này mỗi giao dịch này sẽ có một giao dịch bù trừ tương ứng.

23
00: 04: 44, 750--> 00: 05: 03, 410
Vai trò của các giao dịch đền bù này là thưởng cho những thay đổi trong CSDL . Và cách giải quyết là khi giao dịch xảy ra lỗi, chẳng hạn như nếu giao dịch xảy ra lỗi, giao dịch bù trừ T-3 sẽ được thực thi và một sự kiện sẽ bị bỏ qua.

24
00: 05: 03, 440--> 00: 05: 15, 020
Sự kiện này sẽ được Microsoft tiếp nhận dưới dạng A và B, sau đó mỗi vi dịch vụ này sẽ thực hiện các giao dịch đền bù tương ứng của chúng.

25
00: 05: 15, 200--> 00: 05: 24, 020
Vì vậy, nó sẽ thực thi C một và B sẽ thực thi C hai để đảo ngược các thay đổi trong CSDL tương ứng của chúng.

26
00: 05: 24, 020--> 00: 05: 32, 450
Và thông qua các giao dịch đền bù này, tính nhất quán của dữ liệu sẽ đạt được trên cả ba CSDL .
...
Hãy xem xét kịch bản thương mại điện tử này trong đó chúng ta có ba dịch vụ hoặc vi dịch vụ, nhận đơn đặt hàng từ khách hàng và sau đó dẫn đến yêu cầu giao dịch về dịch vụ thanh toán và dịch vụ kiểm kê.

29
00: 05: 57, 590--> 00: 06: 11, 200
Vì vậy, dịch vụ đặt hàng sẽ có một giao dịch mà tôi có đơn đặt hàng vào CSDL cục bộ của nó và sẽ có một giao dịch bù tương ứng để xóa đơn hàng khỏi CSDL cục bộ hoặc đánh dấu đơn hàng là không thành công.

30
00: 06: 11, 480--> 00: 06: 19, 430
Dịch vụ thanh toán sẽ có một giao dịch dẫn đến việc tính phí thẻ tín dụng và cập nhật CSDL địa phương.

31
00: 06: 19, 610--> 00: 06: 30, 950
Và giao dịch bồi thường tương ứng sẽ là cải tổ thẻ tín dụng và thực hiện các thay đổi đối với CSDL địa phương để phản ánh rằng khoản phí đã được hoàn lại.
...
Trong trường hợp này, tôi sẽ sử dụng Soga và phân phối Saga thay thế cho nhau. Nhưng trong bối cảnh vi dịch vụ, chúng tôi đang đề cập đến các dịch vụ phân tán.
...
Mẫu Saga được sử dụng để quản lý tính nhất quán của dữ liệu trên các vi dịch vụ . Nó liên quan đến việc sử dụng. Các giao dịch cục bộ để duy trì dữ liệu giao dịch đến CSDL và liên quan đến việc sử dụng các giao dịch bù để thu hồi, CSDL thay đổi trong trường hợp thất bại, lý do giao dịch bù được sử dụng là vì không thể sử dụng khôi phục giao dịch CSDL để thu hồi .
...
Trong sự kiện vũ đạo saga. Các vi dịch vụ phát và nhận các sự kiện miền và các sự kiện này sau đó được xử lý bởi từng dịch vụ này.
...
Điều phối viên thực thi Psagot bên ngoài cũng được gọi là người điều phối. Nó là một thành phần di truyền không có bất kỳ loại logic kinh doanh nào, nó cung cấp một số khả năng nhất định để xác định luồng và thực hiện việc gọi các dịch vụ theo tầng được xác định bởi người thiết kế các vi dịch vụ .
...
Có nhiều bộ điều phối bên ngoài có thể được sử dụng để xây dựng câu chuyện với các vi dịch vụ . Ví dụ như BPM hoặc công cụ quy trình làm việc.
...
Nếu nó chưa được xử lý thì giao dịch sẽ được xử lý. Một phản hồi sẽ được tạo và lưu vào CSDL và gửi lại cuộc gọi.
...
Thay vào đó, nó sẽ nhận phản hồi từ CSDL và gửi lại cho người gọi. Bây giờ hãy nói về những thất bại.
...
Họ phải thực hiện thành công. Nếu không, dữ liệu trên các vi dịch vụ sẽ chuyển sang trạng thái không nhất quán để xây dựng khả năng khôi phục sau các giao dịch bồi thường không thành công.
...
Mỗi dịch vụ này sẽ duy trì trạng thái của chúng trong CSDL riêng cho phiên bản này. Một lần triển khai, thay vì duy trì trạng thái trong các CSDL riêng biệt, sẽ duy trì trạng thái và các bộ sưu tập trong CSDL chung.
...
Tất cả đều là các lớp kho lưu trữ, mở rộng lớp dựa trên thủ công, viết và đọc từ các bộ sưu tập tương ứng của chúng trong CSDL du lịch và Mongo DB.
...
Đây là cách bắt đầu quy trình trong chủ đề đặt chỗ ở Saagar. Chúng ta sẽ thấy biến chứa tên của chủ đề Kafka.
...
Đây là định nghĩa từ Wikipedia. Bây giờ mối quan tâm của chúng tôi là các vi dịch vụ, có thể được coi là các ứng dụng độc lập.

3
00: 00: 27, 240--> 00: 00: 37, 560
Hãy cùng tìm hiểu sâu hơn về cách các vi dịch vụ sử dụng API. Các vi dịch vụ cung cấp API để các vi dịch vụ khác sử dụng.
...
Một số người tiêu dùng này thậm chí có thể ở bên ngoài tổ chức sở hữu vi dịch vụ cho những tương tác như vậy.
...
Dịch vụ vi mô. Chúng tôi nhận ra các API này theo nhiều cách. Các nhà thiết kế vi dịch vụ thường sử dụng Hippias và API đồ họa ở mức cao.
...
Các thuộc tính này được quản lý trong một số loại lưu trữ liên tục. Nó có thể là RDBMS hoặc thậm chí có thể là CSDL hàng hải.
...
Vì vậy, điều chúng tôi đang nói ở đây là trạng thái đại diện của ô tô được quản lý trong CSDL và chúng có thể là nhiều phiên bản ô tô được xác định duy nhất bằng số VIN của chúng.

9
00: 01: 24, 090--> 00: 01: 32, 590
Mỗi chiếc xe này có các giá trị khác nhau cho các thuộc tính và chủ sở hữu khác nhau. Bây giờ hãy nghĩ đến một hệ thống có thể truy vấn CSDL này.

10
00: 01: 32, 670--> 00: 01: 38, 640
Hệ thống này có thể yêu cầu CSDL cung cấp thông tin chi tiết về số VIN, số một, hai, ba cho truy vấn này.
...
Nó có thể nằm trong bản ghi CSDL để biểu diễn trạng thái nội bộ này được chuyển đổi sang định dạng khác.
...
Indeed là một trang đăng việc làm cũng cung cấp API nghỉ ngơi. API còn lại này quản lý API RESTful của tài nguyên công việc, một khách hàng quan tâm đến việc lấy thông tin về công việc, thực hiện tất cả thao tác lấy với ID công việc cụ thể và yêu cầu máy chủ API gửi lại phản hồi và định dạng XML khi triển khai EPA đầy đủ. thông tin công việc từ CSDL nội bộ hoặc một số kho lưu trữ liên tục chuyển đổi thành XML và gửi lại cho máy khách còn lại.
...
Chúng ta có thể tạo, truy xuất, cập nhật và xóa tài nguyên. Để thực hiện hoạt động bí mật, khách hàng phải sử dụng htp wob thích hợp.
...
Những người tiêu dùng tư nhân này là thành viên của cùng một nhóm vi dịch vụ hoặc là nhà phát triển các dịch vụ maiko khác.
...
Các khía cạnh này của API được quản lý bên ngoài việc triển khai các vi dịch vụ bằng nền tảng quản lý API.

11
00: 02: 13, 870--> 00: 02: 32, 050
Chúng ta có thể coi ứng dụng, nền tảng quản lý là một công nghệ được sử dụng để giải quyết các mối quan ngại chung của Appia, những mối quan tâm chung này thường là những mối quan tâm liên quan đến quyền truy cập và ủy quyền cho ứng dụng, khu vực ghi nhật ký và phân tích.
...
Các vi dịch vụ hiển thị API của họ thông qua các nền tảng quản lý API này. Nền tảng quản lý EPA hiển thị EPA thông qua một điểm proxy.
...
Mặc dù có nhiều lợi ích khi sử dụng nền tảng quản lý API từ góc độ nhóm phát triển vi dịch vụ .
...
Các vi dịch vụ cung cấp API và người tiêu dùng không kết nối trực tiếp với các API này mà kết nối thông qua nền tảng quản lý API cung cấp cơ chế dựa trên chính sách để giải quyết các mối quan tâm chung liên quan đến API.
...
API đau khổ có thể được phát triển bằng các ngôn ngữ khác nhau bằng cách sử dụng các khung thích hợp và Nhóm vi dịch vụ của sản phẩm Acme đã quyết định xây dựng niềm tin cho Abia bằng cách sử dụng Springboard.
...
Chúng ta sẽ tìm hiểu về các loạt đồ họa và khi kết thúc bài giảng này, chúng ta sẽ có thể giải thích sự khác biệt giữa các ứng dụng bắt giữ và API đồ họa.
...
Vì vậy, bây giờ khách hàng có quyền kiểm soát phản hồi. Vì vậy, nó giống như gọi phần chọn bằng cảm giác từ một bảng CSDL .
...
Dữ liệu là thành phần sau đó tương tác với các nguồn dữ liệu, có thể là CSDL hoặc có thể là các thành phần khác.
...
Tôi khuyên chúng ta nên kiểm tra liên kết này lợi thế về đồ họa. Chúng ta đã biết rằng đồ họa giải quyết vấn đề trang bị quá mức và thiếu vốn mà ứng dụng khách API còn lại gặp phải.
...
Chúng ta sẽ sử dụng dịch vụ nào cho các vi dịch vụ của mình? API RESTful hoặc đồ họa? Vâng, câu trả lời là cả hai không loại trừ lẫn nhau.

5
00: 00: 37, 250--> 00: 00: 50, 210
Chúng ta cần chọn cái phù hợp hơn với mục đích sử dụng cụ thể của chúng ta tại thời điểm này. API RESTful phổ biến hơn nhiều so với API đồ họa, nhưng điều đó đang thay đổi.
...
Chúng ta có thể truy vấn trên dịch vụ, các truy vấn đến được xác thực và thực thi dựa trên lược đồ đó. Lược đồ được xác định bằng ngôn ngữ định nghĩa lược đồ là định nghĩa lược đồ bất khả tri của ngôn ngữ lập trình.
...
Và đây chính là điều khiến mọi thứ trở nên thú vị và sinh động. Chúng ta không thể làm điều này trong API. Vì vậy, trong ví dụ này, khách hàng đang yêu cầu máy chủ trả về mô tả, điểm đến và số đêm chỉ được lấp đầy.
...
Các sản phẩm của Acme mà các nhà phát triển ứng dụng đang sử dụng API sản phẩm Acme đang phàn nàn và Nhóm vi dịch vụ của sản phẩm Acme đã quyết định triển khai API đồ họa cho sản phẩm.
