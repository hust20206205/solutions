...
Trang chủTrang chủBảng chú giảiThiết kế hướng tên miềnThiết kế chiến thuật
...
Các yếu tố của thiết kế chiến thuật trong Thiết kế hướng tên miền (DDD) như sau:

Ngữ cảnh bị giới hạn : Ngữ cảnh bị giới hạn xác định ranh giới rõ ràng xung quanh một phần cụ thể của mô hình miền và ngôn ngữ phổ biến đi kèm với nó.
