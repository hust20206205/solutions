...
**Miền (Domain)**
Miền đề cập đến phạm vi của kiến thức và vấn đề mà hệ thống hoặc dự án cụ thể đang xử lý.

Về góc độ kinh doanh: miền đại diện cho một lĩnh vực hoặc ngành mà doanh nghiệp hoạt động.
Về góc độ phần mềm: miền có thể coi là đại diện cho không gian vấn đề cho phần mềm đó.

Miền được tạo thành từ nhiều **tên miền phụ (sub-domain)**
