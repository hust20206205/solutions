...
=>Cần bối cảnh là chính những hoàn cảnh hoặc sự kiện này hình thành nên bối cảnh cho một tuyên bố hay một ý tưởng?
...
Dự án được thực hiện bởi nhiều nhóm làm việc song song trên mã nguồn. Mỗi nhóm chịu trách nhiệm cho một phần của mô hình, nhưng các phần này không độc lập và có ít tương tác chéo. Mỗi nhóm bắt đầu từ một mô hình lớn, chia nhỏ và thực thi. Khi một nhóm tạo một mô-đun và chia sẻ nó, các nhóm khác có thể thêm chức năng vào mô-đun đó. Tuy nhiên, thay đổi này có thể ảnh hưởng đến toàn bộ mô hình và gây hỏng tính năng của ứng dụng. Khó khăn nảy sinh khi mỗi nhóm tập trung vào "sân chơi riêng" của mình mà không có sự hiểu biết rõ ràng về các phần khác của dự án.
